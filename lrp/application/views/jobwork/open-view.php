...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<div class="content-body">		
			<form method="post" id="data_form" method="post" action="<?php echo base_url(); ?>jobwork/save">
					...
					<div class="card card-block">
						<div class="col-md-12">
								...
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-7">
											...
											<input type="hidden" id="product_id" value="<?=$list[0]->pid?>"> </div>
									</div>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-7">
											<?php 
												$subcat1= explode('&rArr;',$product_category_array_title[0]['title']); 
												//print_r($subcat1);		
												?>
											<select id="sub_cat1" name="product_cat[]" class="form-control" disabled>
											  <option value="" disabled="disabled"> --- Select ---</option>
											  <option value='<?php echo $product_category_array_title[0]['id']?>' selected="selected"><?php echo $subcat1[1]?></option>
											</select>							
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-md-7">
											<select id="sub_sub_cat1" name="product_cat[]" class="form-control select-box" disabled>
											  <option value="" disabled="disabled"> --- Select ---</option>
											  <option value='<?php echo $product_category_array_title[1]['id']?>' selected="selected"><?php echo $subcat1[2]?></option>
											</select>
										</div>
									</div>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									<div class="row">
										<div class="col-md-5">Sub Category</div>
										<div class="col-md-7">
											<select id="sub_cat" name="sub_cat" class="form-control required" required>
								...
								<div class="col-md-4">
									<div class="row">
										<div class="col-md-5">Sub Sub Category</div>
										<div class="col-md-7">
											<select id="sub_sub_cat" name="sub_sub_cat" class="form-control select-box" required>
												<option value="" > --- Select ---</option>			  
											</select>
										</div>
									</div>
							...
							<div class="form-group row">
								<div class="col-md-4">
									<div class="row">
										<div class="col-md-5">Jobwork Service Type</div>
										<div class="col-md-7">
											<select id="jobwork_service_type" name="jobwork_service_type" class="form-control select-box" required>
												<option value="" > --- Select ---</option>			  
			...
			<div class="modal-dialog">
				<div class="modal-content mdcontent">
					...
					<div class="modal-body">
						<form class="payment" method="post" action="<?php echo base_url()?>jobwork/addcomponentJobwork">
							<div class="row mb-2" style="display:none;">
								<div class="col">
									<div class="input-group modinput"> </div>
								</div>
							</div>
							<input type="hidden" name="req_jobwork_id" value="<?=$list[0]->jobcard_id?>">
							<input type="hidden" name="req_product_id" value="<?=$list[0]->pid?>">
							<input type="hidden" name="pro_serial" id="serial" class="form-control" value="<?php echo $list[0]->serial; ?>" readonly>
							<div class="row mb-1">
								<div class="col">
		...
		<div id="sendused" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content mdcontent">
					...
					<div class="modal-body">
						<form class="payment" method="post" action="<?php echo base_url()?>jobwork/addComponentMasterJobwork">
							<div class="row mb-1">
								<div class="col">
									<div class="input-group modinput">
							...
							<div class="row mb-1">
								<div class="col">
									<div class="input-group modinput">
										...
										<input type="hidden" name="req_jobwork_id_component" value="<?=$list[0]->jobcard_id?>">
										<input type="hidden" name="req_product_id_component" value="<?=$list[0]->pid?>">
										<input type="hidden" name="pro_component_serial" id="serial" class="form-control" value="<?php echo $list[0]->serial; ?>" readonly> </div>
								</div>
							</div>
							<div class="row mb-1">
								<div class="col">
...
function getcomponent(){
		...
		$('#conditionsdp3').select2({
			tags: [],
			ajax: {
				url: baseurl + 'pending/getcomponents?pid='+product_id,
				dataType: 'json',
				type: 'GET',
				quietMillis: 50,
				data: function (product) {
