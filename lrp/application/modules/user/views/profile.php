                    ...
                    <div class="card card-block">
                        <div class="">
                            <h3 class="box-title text-center">My Account
                                <small><?php //print_r($user_data);?></small>
                            </h3>
                        </div>
                            ...
                            <div class="box-body box-profile">
                                <div class="col-md-4">
                                    <div class="pic_size" id="image-holder">
										<?php 
										$profile_pic = ($user_data[0]['profile_pic'] == 'example.png') ? substr_replace(base_url(),'',-6).'userfiles/customers/'.$user_data[0]['profile_pic'] : substr_replace(base_url(),'',-6).'app-assets/images/agencykyc/'.$user_data[0]['profile_pic'];
										?>
                                        <img class="height-200 setpropileam" src="<?php echo $profile_pic;?>" alt="User profile picture">
                                    </div>
                                    <br>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group has-feedback clear-both">
                                        ...
                                        <h5><?php /*echo $user_data[0]['name'];*/echo(isset($user_data[0]['name']) ? $user_data[0]['name'] : ''); ?></h5>
