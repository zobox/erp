...
//echo $where;
	...
	public function products_refurbishment_cost_data(){
		$head['title'] = "Products Refurbishment Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_refurbishment_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	
	public function products_refurbishment_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_refurbishment_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
		$objPHPExcel->getActiveSheet()->SetCellValue('C1', 'Product Category');
		$objPHPExcel->getActiveSheet()->SetCellValue('D1', 'Selling Price');
		$objPHPExcel->getActiveSheet()->SetCellValue('E1', 'Cost Type');
		$objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Cost Amount');
	...
	public function products_packaging_cost_data(){
		$head['title'] = "Products Packaging Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_packaging_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	public function products_packaging_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_packaging_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
	...
	public function products_after_sales_suppport_cost_data(){
		$head['title'] = "Products After Sales Suppport Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_after_sales_suppport_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	public function products_after_sales_suppport_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_after_sales_suppport_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
	...
	public function products_promotion_cost_data(){
		$head['title'] = "Products Promotion Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_promotion_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	public function products_promotion_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_promotion_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
	...
	public function products_hindizo_infra_cost_data(){
		$head['title'] = "Products Hindizo Infra Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_hindizo_infra_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	public function products_hindizo_infra_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_hindizo_infra_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
	...
	public function products_hindizo_margin_cost_data(){
		$head['title'] = "Products Hindizo Margin Cost Data";
		$head['usernm'] = $this->aauth->get_user()->username;
		$this->load->view('fixed/header', $head);
		$this->load->view('reports/products_hindizo_margin_cost_data', $data);
		$this->load->view('fixed/footer');
	}
	public function products_hindizo_margin_cost_data_download(){
		$this->load->library('excel');
		$fileName = 'Products_hindizo_margin_cost_data.xlsx';
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Hindizo Name');
		$objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Hindizo Product Code');
