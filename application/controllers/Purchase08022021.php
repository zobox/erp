...
class Purchase extends CI_Controller
{
	...
	public function serial_excel(){
		...
		//print_r($Pdata);die;
		$qty = $Pdata->qty - $Pdata->pending_qty;
		
		$fileName = 'serial excel.xlsx';  
		$objPHPExcel = new PHPExcel();
		$objPHPExcel->setActiveSheetIndex(0);
		$objPHPExcel->getActiveSheet()->mergeCells('A1:J1');
		$objPHPExcel->getActiveSheet()->SetCellValue('A1', 'Purchase Order - '.prefix(2).$Pdata->tid);
		...
		for($i = 1;$i<=$qty;$i++) 
        {
            ...
            $objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, $Pdata->product);
