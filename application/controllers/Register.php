...
class Register extends CI_Controller
{
    ...
    public function load_list()
    {
        ...
        foreach ($list as $promo) {
            ...
            $row[] = $promo->c_date;
            $row[] = $promo_status;
            $row[] = '<a href="#" class="btn btn-success btn-sm" data-id="' . $promo->id . '" data-stat="0"  data-toggle="modal" data-target="#view_register" ><i class="fa fa-eye"></i> ' . $this->lang->line('View') . ' </a> <a href="#" data-object-id="' . $promo->id . '" class="btn btn-danger btn-sm delete-object"><span class="fa fa-trash"></span></a>';
            $data[] = $row;
        }
  ...
  public function product_price_log()
    {
        ...
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
        $this->load->view('register/product_price_log');
        $this->load->view('fixed/footer');
