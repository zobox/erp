...
class Tools extends CI_Controller
{
    ...
    {	
       $status  = $this->input->post('status');
       //$status  = '79-1';
       echo $data['lead'] = $this->tools->updatestatus($status);
    }
	...
	public function leadlocation()
    {
        ...
        $data['lead'] = $this->tools->viewlead();
        //$data['lead1'] = $this->tools->viewlead1();
        
        $this->load->view('fixed/header', $head);
        $this->load->view('lead_location/leadlocation', $data);
        $this->load->view('fixed/footer');
    }
