...
"transactionAmount": "300"
   ...
   public function b2b_newinvoice()
    ...
    {   
        ...
        if ($this->db->insert('geopos_invoices', $data)) {
            ...
            foreach ($pid as $key => $value) {                
				...
				/* echo "<pre>";
				echo "product_tax-".$product_tax[$key];
				echo "purchase_price-".$purchase_price;
				echo "price-".$price;
				echo "netSubTotal-".$netSubTotal;
				echo "product_id-".$product_id[$key];
				echo "product_price_margin-".$product_price_margin;
				echo "gst_with_margin-".$gst_with_margin;
	...
	public function actionstr14072021()
    {   
        /* echo "<pre>";
        print_r($_REQUEST);
        echo "</pre>"; exit; */
