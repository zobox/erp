...
//search product in stock transfer
    ...
    public function search_product_by_serial()
    {
        ...
        $qw .= '(tbl_warehouse_serials.status!=0 && tbl_warehouse_serials.status!=2 && tbl_warehouse_serials.status!=3 && tbl_warehouse_serials.status!=8 && tbl_warehouse_serials.is_present=1 && geopos_product_serials.status!=8 && geopos_product_serials.status!=0) AND ';
	...
	*/
	 ...
	 public function invoice2_search()
    {
        ...
        if ($name) {
            ...
            a.product_des,a.unit FROM geopos_products as a 
	...
	public function invoice2_searchb2b1282021()
    {
		$result = array();
        $out = array();
        $row_num = $this->input->post('row_num', true);
	...
	public function stock_return12082021()
    {
		$result = array();
        $out = array();
        $row_num = $this->input->post('row_num', true);
