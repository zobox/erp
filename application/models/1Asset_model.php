...
{
    var $table = 'tbl_asset';
    var $column_order = array(null, 'tbl_asset.asset_name', 'tbl_asset.qty', 'tbl_asset.product_code', 'geopos_product_cat.title', 'tbl_asset.product_price', null); //set column field database for datatable orderable
    var $column_search = array('tbl_asset.asset_name', 'tbl_asset.product_code', 'geopos_product_cat.title', 'geopos_warehouse.title'); //set column field database for datatable searchable
  ...
  private function _get_datatables_query_asset($id = '', $w = '', $sub = '')
     ...
     private function get_tbl_asset()
    {
        ...
        $this->db->select('tbl_asset_purchase.id,tbl_asset_purchase.tid,tbl_asset_purchase.invoicedate,tbl_asset_purchase.invoiceduedate,tbl_asset_purchase.total,tbl_asset_purchase.status,tbl_asset_purchase.items,tbl_asset_purchase.pending_qty,geopos_supplier.name,geopos_supplier.id as supplier_id');
...
public function lastpurchase()
    ...
    public function getProductRecords(){
        ...
        $this->db->join("geopos_warehouse as w","c.id=w.cid","inner");
