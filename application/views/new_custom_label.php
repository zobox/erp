  ...
  <body style="width:300px;height: 188px;">
    ...
    <table style="width: 300px;">
                        ...
                        <table class="table-box" style="width: 300px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <table>
                                            <tbody style="vertical-align: top;">
                                                <tr>
                                                    ...
                                                    <td style="font-size: 18px;padding-bottom:12px;vertical-align: top;font-weight: bold;">: <?=$product_detail[0]->product_name;?></td>
                                                </tr>
                                                <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 18px;vertical-align: top;padding-bottom:12px;">:   <?=$product_detail[0]->unit_name;?> </td>
                                                </tr>
                                            <?php } ?>
                                              <tr >
                                                    
                                                    <td style="font-size: 18px;padding-bottom:12px;vertical-align: top;">: <?=$product_detail[0]->colour_name;?></td>
                                                </tr>
                                                <tr >
                                                    
                                                    <td style="font-size: 18px;padding-bottom:12px;vertical-align: top;">: &#8377; <span style="font-weight: bold;"><?=$product_detail[0]->price;?>/-</span> <span style="font-size: 10px;">Inclusive of all Taxes</span></td>
                                                </tr>
                                    ...
                                    <td style="text-align: left;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;vertical-align: top;width:100px;padding:17px 5px;"><table>
                                            <tbody>
                                                <?php
                                                if($product_detail[0]->product_type!=2)
                                                {
                                                ...
                                                <tr>
                                                   <td style="width:200px !important;padding: 0px 10px 5px;">
                                                        <!--<img alt="Barcode Generator TEC-IT" src="barcode.jpg" style="padding-top: 5px;width:100%;height:40px;">-->
                                                            <!--<img alt='Barcode Generator TEC-IT'
       src='https://barcode.tec-it.com/barcode.ashx?data=<?=$product_detail[0]->imei_1?>&code=Code128&multiplebarcodes=false&translate-esc=true&unit=Fit&dpi=96&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&codepage=Default&qunit=Mm&quiet=0' style="padding-top: 5px;width:150px;height:40px;" >-->

       <barcode type="C39" code="<?=$product_detail[0]->imei_1?>" text="1" class="barcode" size="0.9" height="1.7"/></barcode>
                                            ...
                                            <?php } ?>
                                                <tr style="border-top: 1px solid #000">
                                                    <td style="width:150px;padding: 5px 16px 5px;<?php if($product_detail[0]->product_type==2) echo 'padding-top:30px;';?>">
                                                        <h6 style="margin:0px;">ZUPC <span style="margin-left: 10px;"><?=$product_detail[0]->zupc_code;?></span></h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:150px !important;padding: 0px 10px 10px;padding-top:5px;">
                                                        <!--<img alt="Barcode Generator TEC-IT" src="barcode.jpg" style="padding-top: 5px;width:100%;height:40px;">-->

                                                       <!-- <img alt='Barcode Generator TEC-IT'
       src='https://barcode.tec-it.com/barcode.ashx?data=<?=$product_detail[0]->zupc_code?>&code=Code128&multiplebarcodes=false&translate-esc=true&unit=Fit&dpi=96&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&codepage=Default&qunit=Mm&quiet=0' style="padding-top: 5px;width:150px;height:40px;" >-->
       <barcode type="C39" code="<?=$product_detail[0]->zupc_code?>" text="1" class="barcode" size="0.8" height="1.7"/></barcode>
                               ...
                               <tr>
                                    <td  style="border-left: 1px solid #000;padding:20px 5px;text-align:left;font-size:13px;padding-bottom: 15px;border-right: 1px solid #000;" colspan="2">
                                        <span>Marketed & Sold By: </span><span>Zobox Retails Pvt. Ltd.</span> &nbsp;&nbsp;&nbsp;&nbsp; <span>E-mail: care@zobox.in</span>
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td  style="border-left: 1px solid #000;border-bottom: 1px solid #000;padding-left:5px;text-align:left;font-size:13px;border-right: 1px solid #000;padding-bottom: 20px;" colspan="2">
                    ...
                    <th colspan="2" style="vertical-align: top;">
                        <table class="table-box" style="width: 283px;height: 188px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td  rowspan="1" style="text-align: left;border:1px solid #000;vertical-align: top;width:200px;padding:15px 10px;">
                                        <table>
                                            <tbody style="vertical-align: top;">
                                                <tr>
                                                    <!--<td style="font-size: 9px;vertical-align: top;font-weight: bold;padding-bottom:10px;">Product</td>-->
                                                    <td style="font-size: 15px;padding-bottom:10px;vertical-align: top;font-weight: bold;padding-bottom:10px;"><?=$product_detail[0]->product_name;?></td>
                                                </tr>
                                                 <?php
                                                if($product_detail[0]->product_type!=2)
                                                {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 15px;vertical-align: top;padding-bottom: 10px;padding-bottom:10px;"><?=$product_detail[0]->unit_name;?> </td>
                                                </tr>
                                            <?php } ?>
                                              <tr >
                                                   
                                                    <td style="font-size: 15px;padding-bottom:10px;vertical-align: top;padding-bottom:10px;"><?=$product_detail[0]->colour_name;?></td>
                                                </tr>
                                                <tr >
                                                    ...
                                                    <td style="font-size: 15px;padding-bottom:10px;vertical-align: top;padding-bottom:10px;">&#8377; <span style="font-weight: bold;"><?=$product_detail[0]->price;?>/-</span> <span style="">Inclusive of all Taxes</span></td>
                                                </tr>
                                            
                                                
                                                <tr>
                                                    
                                                    <td style="font-size: 15px;padding-bottom:10px;vertical-align: top;padding-bottom:10px;"><?=$product_detail[0]->qty;?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
     ...
     <!--<img alt='Barcode Generator TEC-IT'
       ...
       <barcode type="C39" code="<?=$product_detail[0]->imei_1?>" text="1" class="barcode" size="0.5" height="1.5" style="min-width: 100px;"/></barcode>
                                                    </td>
                                                 ...
                                                 <?php } ?>
                                                <tr style="border-top: 1px solid #000">
                                                    <td style="padding: 0px 7px 0px;<?php if($product_detail[0]->product_type==2) echo 'padding-top:30px;';?>">
                                                        <h6 style="margin:0px;font-size: 15px;">ZUPC <span style="margin-left: 10px;"><?=$product_detail[0]->zupc_code;?></span></h6>
                                                    </td>
                                                </tr>
                                                <tr>
     ...
     <!--<img alt='Barcode Generator TEC-IT'
       ...
       <barcode type="C39" code="<?=$product_detail[0]->zupc_code?>" text="1" class="barcode" size="0.9" height="1.8" style="min-width: 100px;"/></barcode>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
