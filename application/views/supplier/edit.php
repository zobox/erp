		...
		<?php //print_r($customer);?>
            <form method="post" id="data_form" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url()?>supplier/editsupplier">
				...
				<div class="form-group row">
                 ...
                 {
                  ?>
                 <img src="<?=base_url()?>userfiles/documents/supplier/<?php echo $customer['pan_up'] ?>" style="height:200px;width:200px;">
                    <?php } ?>
                    </div>
                </div>
				<div class="form-group row">
                 ...
                 {
                  ?>
                 <img src="<?=base_url()?>userfiles/documents/supplier/<?php echo $customer['gst_up'] ?>" style="height:200px;width:200px;">
                    <?php } ?>
                    </div>
                </div>
				<div class="form-group row">
                 ...
                 <?php
                 if($customer['cancelled_cheque_up']!='')
                 {
                  ?>
                 <img src="<?=base_url()?>userfiles/documents/supplier/<?php echo $customer['cancelled_cheque_up'] ?>" style="height:200px;width:200px;">
                    <?php } ?>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" id="submit-dataaa" class="btn btn-success margin-bottom"
