                    ...
                    <div class="col-md-8">
                        <div class="">
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().$details['pan_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().$details['gst_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().$details['cancelled_cheque_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
