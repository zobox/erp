                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="">
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('PAN') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['pan'] ?>
                                </div>
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('GST/TIN') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['gst'] ?>
                                </div>
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('RTGS/ IFSC Code') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['rtgs'] ?>
                                </div>
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().'/userfiles/documents/supplier/'.$details['pan_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().'/userfiles/documents/supplier/'.$details['gst_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <img src="<?php echo base_url().'/userfiles/documents/supplier/'.$details['cancelled_cheque_up'];?>" class="img-responsive" style="width:10%;" />
                                </div>
