        ...
        <div class="card-header">
            <h4 class="card-title"><a
                    ...
                    <?php echo $this->lang->line('Add new') ?></a> <a
                        ...
                        class="btn btn-danger rounded small-button">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="clientstable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    <tr>
                        <th>#</th>
                        <th><?php echo $this->lang->line('FranchiseID') ?></th>
...
<div id="deactivate_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo $this->lang->line('are_you_sure_deactivate_customer') ?></p>
            </div>
            <div class="modal-footer">
                   <input type="hidden" class="form-control"
                           id="object-id" name="deactivateid" value="0">
                <input type="hidden" id="action-url" value="customers/deactivate_i">
                <button type="button" data-dismiss="modal" class="btn btn-primary" id="deactivate-confirm"><?php echo $this->lang->line('Deactivate') ?></button>
...
<div id="activate_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <p><?php echo $this->lang->line('are_you_sure_activate_customer') ?></p>
            </div>
            <div class="modal-footer">
                   <input type="hidden" class="form-control"
                           id="object-id" name="activateid" value="0">
                <input type="hidden" id="action-url" value="customers/activate_i">
                <button type="button" data-dismiss="modal" class="btn btn-primary" id="activate-confirm"><?php echo $this->lang->line('Activate') ?></button>
                <button type="button" data-dismiss="modal" class="btn"><?php echo $this->lang->line('Cancel') ?></button>
            </div>
        </div>
    </div>
...
<div id="sendMail" class="modal fade">
    ...
    $(document).ready(function () {
        ...
        $('#clientstable').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('customers/trc_load_list')?>",
                'type': 'POST',
