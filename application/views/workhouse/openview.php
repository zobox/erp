    ...
    <div class="card-content">
      ...
      <div class="card-body">
			...
			<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<input type="hidden" id="product_id" value="<?=$product_info->product_detail->product_id?>">
					</div>
				</div>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-7">
						<input type="number" name="serial" id="serial" class="form-control" value="<?php echo $product_info->product_detail->serial; ?>" readonly>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				...
				<div class="row">
					...
					<div class="col-md-7">
						<select class="form-control"  name="previous_condition" id="previous_condition" disabled>
							...
							<option value="A" <?php if($product_info->product_condition=='A'){ ?> selected='selected' <?php } ?>>Excellent</option>
							<option value="B"<?php if($product_info->product_condition=='B'){ ?> selected='selected' <?php } ?>>Superb</option>					
							<option value="C"<?php if($product_info->product_condition=='C'){ ?> selected='selected' <?php } ?>>Good</option>					
							<option value="D"<?php if($product_info->product_condition=='D'){ ?> selected='selected' <?php } ?>>Ok</option>					
						</select>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="row">
					...
					<div class="col-md-7">
						<select class="form-control" name="previous_condition" id="previous_condition" disabled>
							<option value="" selected="selected">--Select--</option>
							<option value="1" <?php if($product_info->convert_to==1){ ?> selected='selected' <?php } ?>>Excellent</option>
							<option value="2" <?php if($product_info->convert_to==2){ ?> selected='selected' <?php } ?>>Superb</option>	
							<option value="3" <?php if($product_info->convert_to==3){ ?> selected='selected' <?php } ?>>Good</option>					
							<option value="4" <?php if($product_info->convert_to==4){ ?> selected='selected' <?php } ?>>Ok</option>					
						</select>
					</div>
				</div>
			</div>
		...
		<table class="table table-striped table-bordered zero-configuration mt-3">
			...
			<tbody>
				<?php foreach($product_info->components as $key1=>$component){ ?>
				<tr>
		...
		<div class="form-group row">
		 ...
		 <div class="col-sm-2">
		 <a href="#morecomp" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-large btn-danger"
                            > <?php echo $this->lang->line('Add More Component') ?> </a>
          </div>
		  <div class="col-sm-3 ml-1">
		 <a href="#sendused" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-large btn-warning"
                            > <?php echo $this->lang->line('Send Used Component Warehouse') ?> </a>
          </div>
		  <!--<div class="col-sm-2">
		 <a href="#selectproduct" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-large btn-primary"
                            > <?php echo $this->lang->line('Select Product Type') ?> </a>
          </div>-->
		  <?php if($this->aauth->get_user()->roleid==11 || $this->aauth->get_user()->roleid==5){ ?>
          <div class="col-sm-1">
            <input type="submit"
            ...
            <div class="modal-body">
                <form class="payment" method="post" action="<?php echo base_url()?>workhousejob/addcomponentJobwork">
					...
					<div class="row mb-1">
                        <div class="col">
                            <div class="input-group">
							<select id="conditionsdp3" name="items[]" class="form-control required 	select-box" required="" 	multiple="multiple" onfocus="getcomponent();" style="height: 65px !important width: 469.333px !important;">
                      </select>                           
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"
                                id=""><?php echo $this->lang->line('Submit') ?></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="payment" method="post" action="<?php echo base_url()?>workhousejob/addComponentMasterJobwork">
                    ...
                    <input type="hidden" name="pro_component_serial" id="serial" class="form-control" value="<?php echo $product_info->product_detail->serial; ?>" readonly>                           
                            </div>
					...
					<div class="row mb-1">
                        <div class="col">
                            <div class="input-group">
							<input type="text" class="form-control margin-bottom" name="component_qty" id="qty" required="required" placeholder="Quantity">                            
                            </div>
...
$('#sub_cat').on('change',function(event){
  ...
  $("#item_component_id").change(function(){
  	...
  	$.ajax({
  		type:'POST',
  		url : baseurl+'workhousejob/getComponentZupcById',
