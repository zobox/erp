    ...
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" method="post" action="<?php echo base_url(); ?>stock_transfer">
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
								...
								<div class="form-group row">
                                    <div class="col-sm-12">
                                        <h3 class="title">
                                            <?php echo $this->lang->line('Bill To') ?> <?php /*?><a href='#'
                                                                                          class="btn btn-primary btn-sm round"
                                                                                          data-toggle="modal"
                                                                                          data-target="#addCustomer">
                                                <?php echo $this->lang->line('Add Client') ?>
                                ...
                                <!--<div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst1"
                                                                            class="caption"><?php echo $this->lang->line('Search Client'); ?></label>
                                        <input type="text" class="form-control round" name="cst1" id="customer-box-to"
												placeholder="Enter Customer Name or Mobile Number to search"
                                               autocomplete="off"/>
                                        <div id="customer-box-result-to"></div>
                                    </div>
                                </div>
                                <div id="customer1">
                                    <div class="clientinfo">
                                        <?php echo $this->lang->line('Client Details'); ?>
                                        <hr>
                                        <input type="hidden" name="customer_id1" id="customer_id1" value="0">
                                        <div id="customer_name1"></div>
                                    </div>
                                    <div class="clientinfo">
                                        <div id="customer_address2"></div>
                                    </div>

                                    <div class="clientinfo">

                                        <div id="customer_phone1"></div>
                                    </div>
                              ...
                              <div class="col-sm-6" style="padding-top:60px;"><label for=""
                    ...
                    <div id="saman-row">					
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control vat " name="serial_no11[]" id="serialNo-0"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off" readonly></td>
                                <td><input type="text" class="form-control discount" name="product_discount[]"
                                           onkeypress="return isNumber(event)" id="discount-0" readonly
                    ...
                    <input type="hidden" value="search_product_by_serial" id="billtype">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><label for="transporter_name" class="caption"><?php echo $this->lang->line('Transporter Name') ?></label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Transporter Name" name="transporter_name" value="">
						</div>
					</div>
					
					<div class="col-sm-4"><label for="transporter_id" class="caption"><?php echo $this->lang->line('Transporter ID') ?></label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Transporter ID" name="transporter_id" value="">
						</div>
					</div>
					
					<div class="col-sm-4"><label for="aprox_distance" class="caption">Approximate Distance (in KM)*</label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Approximate Distance (in KM)" name="aprox_distance" value="" required>
						</div>
					</div>	
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<label for="taxformat"
							   class="caption">Mode</label>
						<select class="form-control round" id="mode" name="mode">
					...
					<div class="col-sm-4">
						<label for="vehicle_type"
							   class="caption">Vehicle Type</label>
						<select class="form-control round" id="vehicle_type" name="vehicle_type">
							<option value="Regular" >Regular</option>
                            <option value="Over Dimensional Cargo" >Over Dimensional Cargo</option>                            
						</select>
					</div>
					
					<div class="col-sm-4"><label for="vehicle_no" class="caption">Vehicle No.*</label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Vehicle No." name="vehicle_no" value="" required>
						</div>
					</div>				
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><label for="transporter_doc_no" class="caption">Transporter Doc. No</label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Transporter Doc. No" name="transporter_doc_no" value="">
						</div>
					</div>
					
					<div class="col-sm-4"><label for="transport_date" class="caption">Date</label>
						<div class="input-group">
							<div class="input-group-addon">
							<span class="icon-file-text-o" aria-hidden="true"></span>
							</div>
							<input type="text" class="form-control round" placeholder="Date" name="transport_date" data-toggle="datepicker" autocomplete="false">
						</div>
					</div>
				...
				<div class="form-group row">
					<div class="col-sm-12 text-center">
						<div class="input-group text-center d-block">
							...
							<input type="hidden" value="stock_transfer" id="action-url">
						</div>
					</div>
				</div>
...
<div class="modal fade bd-example-modal-lg" data-backdrop="static" data-keyboard="false" tabindex="-1" id="loader-modal">
