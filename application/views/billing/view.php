                ...
                <div id="invoice-company-details" class="row mt-2">
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                        <img src="<?php $loc = location($invoice['loc']); echo base_url('userfiles/company/' . $loc['logo']) ?>"
                             class="img-responsive p-1 m-b-2" style="max-height: 120px;margin-left:-13px;">
                             <p class="text-muted"><span style="font-size:20px;"><b>Zobox Retails Pvt. Ltd.</b></span></p>
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            echo '<li class="text-bold-800">' . $loc['cname'] . '</li><li>' . $loc['address'] . '</li><li>' . $loc['city'] . ',</li><li>' . $loc['region'] . ',' . $loc['country'] . ' -  ' . $loc['postbox'] . '</li>';  
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right mt-2">
                        ...
                        <p class="pb-1"> <?php if ($invoice['i_class'] == 1) {
							...
							<p>E - WAY BILL:  <?php echo $invoice['ewayBillNo']; ?></p>
                        <ul class="px-0 list-unstyled">
                ...
                <div id="invoice-company-details" class="row mt-2">
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                        ...
                        echo base_url('userfiles/company/' . $loc['logo']) ?>"
                             class="img-responsive p-1 m-b-2" style="max-height: 120px;margin-left:-12px;">
                        <!--<p class="text-muted"><?php echo $this->lang->line('From') ?></p>-->
                        <p class="text-muted"><span style="font-size:20px;"><b>Zobox Retails Pvt. Ltd.</b></span></p>
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            echo '<li class="text-bold-800">' . $invoice['from_address']['cname'] . '</li><li>' .$invoice['from_address']['address'] . '</li><li>' . $invoice['from_address']['city'] . ',</li><li>' . $invoice['from_address']['region'] . ',' . $invoice['from_address']['country'] . ' -  ' . $invoice['from_address']['postbox'] . '</li>' ?>
                            </li>
							<?php if ($loc['taxid']) echo $this->lang->line('Tax') . ' ID : ' . $loc['taxid']; ?>
                        </ul>
                    </div>
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right mt-2">
                        <h2><?php echo $this->lang->line('INVOICE') ?></h2>
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-5 col-sm-12 text-xs-center text-md-left"> <?php if ($invoice['name_s']) { ?>
                                ...
                                <ul class="px-0 list-unstyled">
                                    ...
                                    <li class="text-bold-800"><strong
                                                class="invoice_a"><?php echo $invoice['name_s'] . '</strong></li><li>' . $invoice['address_s'] . '</li>' . $invoice['city_s'] . ',' . $invoice['region_s'] . '</li><li>' . $invoice['country_s'] . ',' . $invoice['postbox_s'] . '</li><li>' . $this->lang->line('Phone') . ' : ' . $invoice['phone_s'] . '</li><li>' . $this->lang->line('Email') . ' : ' . $invoice['email_s']; ?>
                                    </li>
                                </ul>
                            <?php } ?>
                        </div>
