                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group d-flex">
                                <div class="col-sm-6 col-form-label custom-radio">
                                ...
                                <div class="col-sm-6 col-form-label custom-radio ml-2">
                        ...
                        <div class="col-sm-5 ml-2"><input type="text" class="form-control" name="cst" id="trans-box"
							...
							<div class="row">
								<div class="col-sm-5">
									<div class="form-group row">
										<label class="col-sm-5 col-form-label" for="toBizName"><?php echo $this->lang->line('C/o') ?><span style="color: red;">*</span> </label>
										<div class="col-sm-7">
											<input type="hidden" name="payer_id" id="customer_id" value="0">
											<input type="text" class="form-control required" name="payer_name" id="customer_name"> </div>
									</div>
									<div class="form-group row">
										<label class="col-sm-5 col-form-label" for="amount"> <?php echo $this->lang->line('Amount') ?></label>
										<div class="col-sm-7">
											<input type="text" placeholder="Amount" class="form-control margin-bottom  required" name="amount" value="0"
                                   onkeypress="return isNumber(event)"> </div>
									</div>
									<div class="form-group row">
										<label class="col-sm-5 col-form-label" for="product_price"><?php echo $this->lang->line('Type') ?></label>
										<div class="col-sm-7">
											<select name="pay_type" class="form-control">
												<option value="Income" selected>
													<?php echo $this->lang->line('Income') . ' / ' . $this->lang->line('Credit') ?>
												</option>
												<option value="Expense">
													<?php echo $this->lang->line('Expense') . ' / ' . $this->lang->line('Debit') ?>
												</option>
											</select>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-5 col-form-label" for="product_price"><?php echo $this->lang->line('Method') ?> </label>
										<div class="col-sm-7">
								...
								<div class="col-sm-6">
									<div class="form-group row">
										<label class="col-sm-4 col-form-label" for="pay_cat"><?php echo $this->lang->line('To') . ' ' . $this->lang->line('Account') ?></label>
										<div class="col-sm-8">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label" for="date"><?php echo $this->lang->line('Date') ?></label>
										<div class="col-sm-8">
											<input type="text" class="form-control required" name="date" data-toggle="datepicker" autocomplete="false"> </div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 col-form-label" for="pay_cat"><?php echo $this->lang->line('Category') ?></label>
										<div class="col-sm-8">
