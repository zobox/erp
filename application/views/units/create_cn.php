<div class="card card-block">
    ...
    <div class="card card-block ">
        ...
        <form method="post" id="data_form" class="card-body">
            ...
            <h5><?php echo $this->lang->line('Add') ?><?php echo $this->lang->line('Conditions') ?></h5>
            <hr>
            ...
            <div class="form-group row">
                ...
                <label class="col-sm-1 col-form-label"
                       for="pvars"><?php echo $this->lang->line('Variables') ?>*</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="hidden" value="units/create_cn" id="action-url">
                </div>
            </div>
