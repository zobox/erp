                        ...
                        <div class="card-body">
							...
							<li class="nav-item">
                                    <a class="nav-link active show" id="base-tab1" data-toggle="tab"
                                       ...
                                       aria-selected="false"><?php echo $this->lang->line('General Details') ?></a>
                                </li>
								<li class="nav-item">
                                    <a class="nav-link" id="base-tab4" data-toggle="tab" aria-controls="tab4"
                                       href="#tab4" role="tab"
                                       aria-selected="true"><?php echo $this->lang->line('Upload') ?></a>
                                </li>
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
									...
									<div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-3 col-lg-2">
                                            <div class="radio">
											  <label><input type="radio" value="1" name="website_id" id="zobox" <?php if($franchise['website_id']==1 || $franchise['website_id']==0){ ?> checked <?php } ?>> ZoBox</label>
											</div>																						
                                        </div>
										
										<div class="col-sm-3 col-lg-2">
											<div class="radio">
											  <label><input type="radio" value="2" name="website_id" id="zoloot" <?php if($franchise['website_id']==2){ ?> checked <?php } ?>> ZoLoot</label>
											</div>
										</div>
									...
									<div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-3 col-lg-2">
                                            <div class="radio">
											  <label><input type="radio" value="2" name="personal_company" id="company" <?php if($franchise['personal_company']==2 || $franchise['personal_company']==0){ ?> checked <?php } ?>> Company</label>
											</div>																						
                                        </div>
										
										<div class="col-sm-3 col-lg-2">
											<div class="radio">
											  <label><input type="radio" value="1" name="personal_company" id="personal" <?php if($franchise['personal_company']==1){ ?> checked <?php } ?>> Individual</label>
											</div>
										</div>
									...
									<div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-3 col-lg-2">
                                            <div class="radio">
											  <label><input type="radio" value="1" name="module" <?php if($franchise['module']==1 || $franchise['module']==0){ ?> checked <?php } ?>> ENTERPRISE</label>
											</div>																						
                                        </div>
                                ...
                                <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
									...
									<div class="form-group row">
										<label class="col-sm-4 col-form-label"
											   for="cancelled_cheque_up"><?php echo $this->lang->line('ABCD') ?>
											</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="RTGS/ IFSC Code"
												   ...
												   id="rtgs_ifsc_code" value="<?php echo $franchise['rtgs_ifsc_code'] ?>" required>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
                                               for="rtgs_ifsc_code"><?php echo $this->lang->line('Account Holder') ?></label>

                                        <div class="col-sm-8">
                                            <input type="text" placeholder="<?php echo $this->lang->line('Account Holder') ?>"
                                                   class="form-control margin-bottom b_input" name="account_holder"												   
												   id="account_holder" value="<?php echo $franchise['account_holder'] ?>" required>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Accounts Number"
												   ...
												   id="account_no" value="<?php echo $franchise['account_no'] ?>" required>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Bank Name"
												   ...
												   id="bank_name" value="<?php echo $franchise['bank_name'] ?>" required>
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Branch"
												   ...
												   id="branch" value="<?php echo $franchise['branch'] ?>" required>
                                        </div>
                                    </div>
