                    ...
                    <table id="recent-orders" class="table table-hover mb-1">
                        ...
                        foreach ($recent as $item) {
							...
							switch($item['type']){
								case 1: $prefix = 'STFO#';
								break;
								case 2: if($item['pmethod_id']==1){ $prefix = 'PCS#'; }else{ $prefix = 'POS#'; }
								break;
								case 3: $prefix = 'STF#';
								break;
								case 4: $prefix = 'PO#';
								break;
								case 6: $prefix = 'POBB#'; $item['status']='paid';
								break;
								case 7: $prefix = 'SSR#';
								break;
							}
                            ...
                            echo '    <tr>
                                <td class="text-truncate"><a href="' . base_url() . $page . '/view?id=' . $item['id'] . '">' . $prefix .$item['tid'] . '</a></td>
