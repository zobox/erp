    ...
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" method="post" action="<?php echo base_url(); ?>calculator/generateewb">
                    <div class="row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><label for="aprox_distance" class="caption">Approximate Distance (in KM)</label>
						<div class="input-group">
							...
							<input type="text" class="form-control round" placeholder="Approximate Distance (in KM)" name="aprox_distance" value="">
						</div>
					</div>	
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><label for="vehicle_no" class="caption">Vehicle No.</label>
						<div class="input-group">
							...
							<input type="text" class="form-control round" placeholder="Vehicle No." name="vehicle_no" value="">
						</div>
					</div>				
				...
				<div class="form-group row">
					...
					<div class="col-sm-4"><label for="transport_date" class="caption">Date</label>
						<div class="input-group">
							...
							<input type="text" class="form-control round required" placeholder="Date" name="transport_date" data-toggle="datepicker" autocomplete="false">
						</div>
					</div>
				...
				<div class="form-group row">
					<div class="col-sm-12">
						<div class="input-group">
							...
							<input type="hidden" value="calculator/generateewb" id="action-url">
						</div>
					</div>
				</div>
