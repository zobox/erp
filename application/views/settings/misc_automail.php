    ...
    <div class="card card-block">
        ...
        <form method="post" id="product_action" class="form-horizontal">
            <div class="card-body">
                ...
                <h5><?php echo $this->lang->line('Email') . ' ' . $this->lang->line('Alert') ?></h5> <br>
                ...
                <div class="row">
					<div class="col-sm-5">
						<div class="form-group row">
							<label class="col-sm-5 col-form-label" for="tzone"><?php echo $this->lang->line('Transactions') . ' ' . $this->lang->line('Email') ?></label>
							<div class="col-sm-7">
					...
					<div class="col-sm-6">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label" for="tzone"><?php echo $this->lang->line('Transactions') . ' ' . $this->lang->line('Delete') . ' ' . $this->lang->line('Email') ?></label>
							<div class="col-sm-8">
                ...
                <div class="row">
					<div class="col-sm-5">
						<div class="form-group row">
							<label class="col-sm-5 col-form-label" for="tzone"><?php echo $this->lang->line('Invoice') . ' ' . $this->lang->line('Delete') . ' ' . $this->lang->line('Email') ?></label>
							<div class="col-sm-7">
					...
					<div class="col-sm-6">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label" for="product_cat_name"><?php echo $this->lang->line('Email') ?></label>
							<div class="col-sm-8">
                            <input type="email"
