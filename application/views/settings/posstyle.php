                ...
                <div class="row">
					<div class="col-sm-5">
						<div class="form-group row">
							<label class="col-sm-5 col-form-label" for="product_name"><?php echo $this->lang->line('POS') ?></label>
							<div class="col-sm-7">
					...
					<div class="col-sm-6">
						<div class="form-group row">
							<label class="col-sm-4 col-form-label" for="product_name"><?php echo $this->lang->line('AllowAssignEmployee') ?></label>
							<div class="col-sm-8">
