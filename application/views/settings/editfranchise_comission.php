				  ...
				  <div class="header row">
					...
					<div class="col-sm-8">
					  <div class="d-flex align-items-center" style="width:100%;">
						...
						<div style="width:20%;padding:11px 28px;text-align: center;font-weight: 600;">Retail (%)</div>
						<div style="width:20%;padding:11px 28px;text-align: center;font-weight: 600;">B2C (%)</div>
						<div style="padding:11px 28px;width:20%;text-align: center;font-weight: 600;">Bulk (%)</div>
						<div style="padding:11px 28px;width:20%;text-align: center;font-weight: 600;">Renting (%)</div>
					  </div>
						...
						<div class="outer-div" style="max-width:100%;">
						  <div class="header row" style="border-top:1px solid #000;">
							<div class="col-sm-4">
							  <div style="padding:11px 28px 11px;"><input type="checkbox" name="mobilephone" checked> <?php echo $cat_data->title; ?></div>
							  
							  <div style="padding:0px 28px 11px;" class="sub_cat_drp">
								<span >                                   
								   <?php foreach($catcommision[$cat_id]['child'] as $scat){ ?>
									<ul style="display:block; padding:0px !important; ">
