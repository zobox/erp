...
​
  ...
  <body style="width:300px;height: 188px;">
    ...
    <table style="width: 300px;">
       ...
       elseif($product_detail[0]->label_size==1 && $label_type!='mini')
       {
        ...
        <table style="width: 283px;vertical-align: top;height: 250px;">
            <thead></thead> 
            <tbody>
                ...
                <tr> 
                    ...
                    <th colspan="2" style="vertical-align: top;">
                        <table class="table-box" style="width: 283px;height: 200px;">
                            <thead></thead>
                            <tbody>

                               
                                <tr>
                                    <td  rowspan="1" style="text-align: left;border:1px solid #000;vertical-align: top;width:258px;height:265px;padding:30px 10px;">
                                        <table>
                                            <tbody style="vertical-align: top;">
                                                <tr>
 ...
 <!--
    ...
    if($product_detail[0]->label_size==5 && $label_type!='mini')
    {
                ...
                <tr>
                        ...
                        <table class="table-box" style="width: 300px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td  rowspan="1" style="text-align: center;border:1px solid #000;vertical-align: top;width:540px;height:534px;padding:30px 165px;">
                                        <table>
                                            <tbody style="vertical-align: top;">
                                                <tr>
