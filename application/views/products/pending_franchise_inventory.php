<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Franchise Pending Inventory') ?> 
            </h5>
            ...
            <div class="card-body">
                ...
                <table id="catgtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    <tbody>
						<?php 
						/* echo "<pre>";
						print_r($pending_serial);
						echo "</pre>"; */
						$i=1;
						foreach($pending_serial as $key=>$data){
						?>
						<tr>
							<td><?php echo $i; ?></td>
							...
							<td><?php echo 'STFO#'.$data->tid; ?></td>
							<td><?php echo $data->franchise_code; ?></td>
							<td>1</td>
							<td><?php echo $data->stock_qty; ?></td>
							<td><a href="<?php echo base_url('productcategory/manual_add?id='.$data->invoice_id) ?>" class="btn btn-success btn-sm view-object"><span class="fa fa-eye">View</span></a></td>
						</tr>
						<?php  $i++; } ?>	
                    </tbody>
                    <tfoot>
