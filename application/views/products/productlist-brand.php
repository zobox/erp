		...
		<input type='hidden' name='sel_cat_id' id='sel_cat_id' value='<?php echo $cat_id; ?>'>
		<table id="productstable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="checkbox" name="chk[<?php echo $prow->pid; ?>]" id='chk<?php echo $prow->pid; ?>' value='<?php echo $prow->pid; ?>'></td>
					<?php if($cost == 0){ ?>
