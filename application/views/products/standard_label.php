<div class="content-body">
    <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
							<div class="col-sm-5">
								<div class="form-group row">
									<label class="col-sm-5 col-form-label" for="product_cat"><?php echo $this->lang->line('Warehouse') ?></label>
									<div class="col-sm-7">
                            ...
                            ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="pay_cat"><?php echo $this->lang->line('Products') ?></label>
                                        <div class="col-sm-8">
                        ...
                        <div class="row">
							<div class="col-sm-5">
								<div class="form-group row">
									<label class="col-sm-5 col-form-label" for="pay_cat"><?php echo $this->lang->line('Serial No') ?></label>
									<div class="col-sm-7">
                                    <select id="serial_no" name="serial_no[]" class="form-control required select-box"
                                multiple="multiple">
                ...
                <hr>
                        <div class="row">
							<div class="col-sm-5">
								<div class="form-group row">
									<label class="col-sm-5 col-form-label" for="standard_label"><?php echo $this->lang->line('standard_label') ?></label>
									<div class="col-sm-7">
                            ...
                            <option value="eu30019">EU30019 65</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="width">BarCode Type</label>
                                        <div class="col-sm-8">
                                        <select class="form-control" style="width:284px;" name="barcode_type">
        ...
        var serial = $('#products_l').val();
          
         var wid =  $('#wfrom').val();
        $("#product_id").attr("value",serial); 
        $("#products_l").attr("disabled",true);
        $('#serial_no').select2({
              
            tags: [],
            ajax: {

                   url: baseurl + 'products/get_serial?wid=' + wid +'&pid=' +serial,
                    dataType: 'json',
                    type: 'POST',
                    quietMillis: 50,
                    data: function (serial) {
