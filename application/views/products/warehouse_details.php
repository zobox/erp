...
<div class="content-body">
                    ...
                    <tr>
                        ...
                        <td><div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo base_url();?>productcategory/serial_barcode?id=<?=$serial->id?>" target="_blank"> BarCode</a>

                                        <div class="dropdown-divider"></div>
                                         <a class="dropdown-item" href="<?php echo base_url();?>productcategory/barcode_label?id=<?=$serial->id?>&serial=<?=$serial->serial?>&label=1" target="_blank"> Mobile 75*50</a>
                                          <div class="dropdown-divider"></div>
                                             <a class="dropdown-item" href="<?php echo base_url();?>productcategory/barcode_label?id=<?=$serial->id?>&serial=<?=$serial->serial?>&label=2" target="_blank">Accessories 75*50</a>
                                          <div class="dropdown-divider"></div>
                                             <a class="dropdown-item" href="<?php echo base_url();?>productcategory/barcode_label?id=<?=$serial->id?>&serial=<?=$serial->serial?>&label=3" target="_blank">Mobile 90*60</a>
                                          <div class="dropdown-divider"></div>
                                             <a class="dropdown-item" href="<?php echo base_url();?>productcategory/barcode_label?id=<?=$serial->id?>&serial=<?=$serial->serial?>&label=4" target="_blank">Accessories 90*60</a>      
                             ...
                             <?php
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success btn-sm sendjobwork" id="<?=$serial->serial?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-print"></i>  Send To Jobwork </button>                                   
                                    <!--<a href="#" class="btn btn-success btn-sm">Send Data To Warehouse</a>-->
                                </div>
                            <?php } ?>
                            </td>
                    </tr>
   ...
   <!-- <script type="text/javascript">
	...
	<script>
	$('.sendjobwork').click(function(){		
		var serial = $(this).attr("id");		
		//alert(serial);
		$.ajax({
			type : 'POST',
			url : baseurl+'productcategory/sendjobwork',			
			data : {serial:serial},		
			cache : false,
