<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Product Brand') ?> <a
                        href="<?php echo base_url('productbrand/add') ?>"
        ...
        <div class="card-content">
            ...
            <div class="card-body table-responsive pt-0">
                ...
                <table id="catgtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    <td>$i</td>
                    <td>$title</td>                    
                    <td><a href='" . base_url("productbrand/edit?id=$cid") . "' class='btn btn-warning btn-sm'><i class='fa fa-pencil'></i> " . $this->lang->line('Edit') . "</a></td></tr>";
