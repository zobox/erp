<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Stock Return Pending Inventory') ?> 
            </h5>
                ...
                <table id="catgtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    <tbody>
						...
						<tr>
                            ...
                            <td><a href="http://localhost/zobox/invoices/view?id=<?php echo $row->id; ?>">SRR#<?php echo $row->tid; ?></a></td>
                            <td><?php echo $row->franchise_code; ?></td>
                            <td><?php echo $row->total_product; ?></td>
                            <td><?php echo $row->stock_quantity; ?></td>
                            <td><a href="<?php echo base_url(); ?>productcategory/stock_return_panding_franchise_view?id=<?php echo $row->id; ?>" class="btn btn-success btn-sm view-object"><span class="fa fa-eye">View</span></a></td>
                        </tr>                   
                        <?php $i++; } ?>    
                    </tbody>
                    </tbody>
