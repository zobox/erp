				...
				<!--<button class="btn btn-pink add_serial btn-sm m-1">   <?php //echo $this->lang->line('add_serial') ?></button>--><div id="added_product"></div>
                    ...
                    if ($product['merge'] == 0) { 
                      ...
                      ?>
                       ...
                       if(sizeof($product_variant) == 0  || count($product_variant)==''){
                        ...
                        ?>
											...
											<?php }else{
												...
												$product_name = explode("-",$productVariants->product_name);
												unset($product_name[0]);
                                                ...
                                                <td><input type="hidden" value="<?= $product_name;?>" /><select name="v_type[]" class="form-control">
                                                        ...
                                                        foreach ($variables as $row) {
                                                            ...
                                                            $title = $row['name'];
                                                            $variation = $row['variation'];
															$variantname = $variation ."-". $title;
                                                            echo "<option value='$cid'";if($product_name == $variantname){echo "selected=''";}echo">$variation - $title </option>";
                                                        }
                                                        ?>
                                                    </select></td>
                                                <td  style="display:none;"><input value="" class="form-control" name="v_stock[]"
                                                ...
                                                <td><input value="<?= $productVariants->alert?>" class="form-control" name="v_alert[]"
                                                           placeholder="<?php echo $this->lang->line('Alert Quantity') ?>*">
                                                </td>
                                                <td>
                                                    <button class="btn btn-red tr_delete">Delete</button>
