                ...
                <li class="nav-item has-sub <?php if ($this->li_a == "sales") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item"><a
                            ...
                            <ul class="menu-content">
                                <li class="menu-item"><a href="<?= base_url(); ?>invoices/b2b_newinvoice"
                                    ><?php echo $this->lang->line('New Invoice'); ?></a>
                                </li>
                                
                                <li class="menu-item"><a
                                            href="<?php echo base_url(); ?>invoices/b2b_manageinvoice"><?php echo $this->lang->line('Manage Invoices'); ?></a>
                                </li>
                            </ul>
                        </li>
        ...
        <?php $s_role = $this->session->userdata('s_role'); ?>
            ...
            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
								...
								<?php } ?>
								<!--<?php echo base_url(); ?>leads/adminleads-->
            ...
            <li class="menu-item">
				...
				i class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="icon-handbag"></i><span><?php echo $this->lang->line('Job Work') ?></span></a>
                    <ul class="dropdown-menu">
            <?php if($this->aauth->premission(5)==1){ ?>
                      <!--  <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
