    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row h-100" style="margin-top: 4px;">
                ...
                <li class="nav-item d-md-none"><a class="d-flex align-items-center justify-content-center h-100" href="<?= base_url() ?>dashboard/"><img
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item d-none d-md-block nav-link "><a style="background:#E91E63;color:#fff;" href="<?= base_url() ?>dashboard"
