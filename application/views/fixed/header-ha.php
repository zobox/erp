...
<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border"
                    ...
                    <ul class="dropdown-menu">
						...
						<li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>invoices/manage_franchise_item"
                                                    data-toggle="dropdown"><?php echo $this->lang->line('Manage Invoices'); ?></a>
                                </li>
 ...
 <li data-menu=""><a class="dropdown-item"
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                 ...
                 <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="icon-briefcase"></i><span><?= $this->lang->line('TRC Third Party') ?></span></a>
                    <ul class="dropdown-menu">
                        
                        <li data-menu="">
                            <a class="dropdown-item" href="<?= base_url(); ?>customers/add_trc"><i
                                        class="icon-list"></i><?php echo $this->lang->line('New TRC'); ?></a>
                        </li>
                        <li data-menu="">
                            <a class="dropdown-item" href="<?= base_url(); ?>customers/trc_list"><i
                                        class="icon-list"></i><?php echo $this->lang->line('Manage TRC'); ?></a>
                        </li>
