    ...
    <div class="card">
        <div class="card-content">
            ...
            <div id="invoice-template" class="card-body">
                ...
                <div id="invoice-company-details" class="row mt-2">
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                        ...
                        echo base_url('userfiles/company/' . $loc['logo']) ?>"
                             class="img-responsive p-1 m-b-2" style="max-height: 120px;padding-left:7px;">
						...
						<div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
							<!--<img src="<?php $loc = location($invoice['loc']); echo base_url('userfiles/company/' . $loc['logo']) ?>"
                              ...
                              <img src="<?php echo base_url('userfiles/company/16088996411285771464.png')?>"
                                 ...
                                 <p class="ml-2"><span style="font-size:20px;"><b><?= $invoice['from_address']['cname'] ?></b></span></p>
						    <!--<p class="ml-2"><?= $invoice['from_address']['cname'] ?></p>-->
                            <!--<p class="ml-2"><span style="font-size:20px;"><b>Zobox Retails Pvt. Ltd.</b></span></p>-->
							<p class="ml-2">
								...
								<tr>
									<td>									
										<?php echo
											$invoice['from_address']['address'] . '<br>' . $invoice['from_address']['city'] . ', ' . $invoice['from_address']['region'] . '<br>' . $invoice['from_address']['country'] . ' -  ' . $invoice['from_address']['postbox'];
										/*if ($loc['taxid']) echo '<br>' . $this->lang->line('Tax') . ' ID: ' . $loc['taxid'];*/
                                        echo '<br>' . $this->lang->line('Tax') . ' ID: ' . $invoice['from_address']['taxid'];
										?>
									</td>						
								</tr>
							</p>
                ...
                <div id="invoice-customer-details" class="row pt-2" style="padding-left:23px;">
