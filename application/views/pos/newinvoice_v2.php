    ...
    <div class="row ">
                ...
                <div class="col p-mobile">
                    <table id="pos_list" class="table-responsive tfr pos_stripe">
                        ...
                        <tr class="item_header bg-gradient-directional-purple white">
                            ...
                            <th width="20%" class="text-center">IMEI</th>
                    ...
                    <div class="row mt-1">
                        <div class="col-3"><input type="hidden" value="0" id="subttlform"
                                                  name="subtotal"> <input type="hidden" value="0"
                                                                          id="custom_discount"><strong>Total Marginal Gst</strong>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <span id="marginal_gst" class="lightMode">0</span></div>
                    </div>
                    <hr>
                    <div class="row mt-1">
                        <div class="col-3"><input type="hidden" value="0" id="subttlform"
     ...
     <?php if($emp['key1']) { ?>
                    ...
                    <label for="employee"><?php echo $this->lang->line('Employee') ?></label>
                        <select id="employee" name="employee" disabled class="form-control form-control-sm">
                            <?php
                            foreach ($employee as $row) {
                                $cid = $row['id'];
                                $title = $row['name'];
								if($cid==$this->session->userdata('id')){ $selected = 'selected'; }else{ $selected = ''; }
                ...
                <div class="tab-content px-1 pt-1">
                    <div class="tab-pane" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                        ...
                        <input type="hidden" value="<?=$swarehouse->id?>" id="s_warehouses">
                    ...
                    <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                        ...
                        <div class="row">
                            <div class="col-4 blue text-xs-center"><?php echo $this->lang->line('Warehouse') ?>
                                <select id="warehouses" name="warehouses" class="selectpicker form-control round teal">
                                    <?php echo $this->common->default_warehouse();
                                    echo '<option value="0">' . $this->lang->line('All') ?></option>

									<?php foreach ($warehouse as $row) { 
										if($swarehouse->id == $row['id']){ $selected = 'selected'; }else{ $selected = ''; } 
                    ...
                    <div class="tab-pane" id="tab4" role="tabpanel" aria-labelledby="base-tab4">
                        <div class="form-group row">
                          ...
                          <input type="hidden" class="form-control" placeholder="Invoice #"
                            ...
                            <div class="col-sm-3"><label for="invocieno"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Invoice #"
                                           name="invocieno11" id="invocieno11"
                                           value="<?php echo $lastinvoice + 1 ?>" disabled>
                                </div>
                            </div>
                            <div class="col-sm-3"><label for="invocieno"
                    ...
                    <?php } ?>
                    <input type="hidden" value="<?=$terms[0]['id']?>" name="pterms">
                    </div>
                </div>
            ...
            <div class="row border-bottom-grey-blue  border-bottom-lighten-4">
                ...
                <div class="col-md-9 pb-1">
                    <input type="text" class="form-control text-center round mousetrap"
                           ...
                           placeholder="Search Product name or scan imei no " id="search_bar"
...
<div class="modal fade" id="Pos_addCustomer" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content ">
            <form method="post" id="product_action" class="form-horizontal" action="<?php echo base_url()?>pos_invoices/createNewCustomer">
                <!-- Modal Header -->
                <div class="modal-header bg-gradient-directional-info white">

                    <h4 class="modal-title" id="myModalLabel"><i
                                class="icon-user-plus"></i> <?php echo 'Add Customer'; ?></h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h5><?php echo "Customer Details"; ?></h5>
                            <div class="form-group row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card-title">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control  text-bold-600 blue-grey"
                                            name="p_amount" placeholder="Amount" onkeypress="return isNumber(event)" id="p_amount" onkeyup="update_pay_pos()" inputmode="numeric" />
                        ...
                        if($_SESSION['s_role'] != 'r_2'){
                        ?> 
                                    <option value='2'><?php echo $this->lang->line('Bank') ?></option>
                                    <option value='3'><?php echo $this->lang->line('UPI') ?></option>
                                    <option value='4'><?php echo $this->lang->line('Rupay Debit Card') ?></option>
                                    <option value='5'><?php echo $this->lang->line('Debit Card (Master, Visa, Maestro)') ?></option>
                                    <option value='6'><?php echo $this->lang->line('Credit card') ?></option>
                                    <option value='7'><?php echo $this->lang->line('EMI Charges') ?></option>
                                    <?php } ?>
                                </select></div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        ?> 
                            <button class="btn btn-info btn-lg btn-block"
                                ...
                                + <?php echo $this->lang->line('Print') ?></button><?php } ?>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('#pos_basic_pay').on("click", function (e) {		
        ...
        var action_url = $('#action-url').val();
        console.log(addObject(o_data, action_url)); 
        setTimeout(
            function () {
                update_register();
            }, 3000);
...
$('#p_method').change(function(){
	var method = $(this).val();
	$.ajax({
		url: baseurl + 'pos_invoices/select_account',
		//dataType: 'json',
		type: 'post',
		cache : false,
		data : {method : method},
		success: function (data) {			
			$('#selected_account').html(data);			
		}
	});
});
