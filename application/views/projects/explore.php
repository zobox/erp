                    ...
                    <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="link-tab"
                        ...
                        <table id="todotable" class="table table-striped table-bordered zero-configuration"
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('Assign Person') ?></th>
                        ...
                        <ul class="timeline">
                            ...
                            foreach ($comments_list as $row) {
                                ...
                                <li class="<?php if (!$flag) {
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <h4 class="timeline-title"><?php if ($row['key3']) echo $row['customer'] . ' Reply <small>(Franchise)</small>'; else echo $row['employee'] . ' Reply <small>(Employee)</small>'; ?></h4>
    ...
    <div id="pop_model" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4 class="modal-title" style="margin-left:170px"><?php echo $this->lang->line('Change Status'); ?></h4>
                ...
                <div class="modal-body"> 
                    <form id="form_model">
                        <div class="row" style="text-align:center;">
                            <div class="col-xs-12 mb-1" style="margin-left: 175px;"><label
