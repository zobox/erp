...
<div class="content-body">
  <div class="card">
    <div class="card-header pb-0">
      ...
      <h5><?php echo $this->lang->line('New Notice Board') ?></h5>
                        ...
                        <div class="col-sm-5">
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label" for="Coupon Title">
                                    <?php echo $this->lang->line('Notice Title') ?>
                                </label>
                                <div class="col-sm-7">
								<input type="text" placeholder="Notice Title" class="form-control margin-bottom required" name="coupon_title" value="">
                                </div>
                            </div>
                        </div>
					...
					<div class="row">
                        <div class="col-sm-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
								<input type="text" class="form-control margin-bottom required" placeholder="Start Date" name="valid_from" data-toggle="datepicker" autocomplete="false">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
							...
							<label class="col-sm-4 col-form-label" for="valid"><?php echo $this->lang->line('Valid Till') ?>
                                ...
                                <div class="col-sm-8">
								<input type="text" class="form-control margin-bottom required" placeholder="end-Date" name="valid_till" data-toggle="datepicker" autocomplete="false">
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-sm-5">
						<div class="form-group row">
                                            <label class="col-sm-5 col-form-label" for="note">
                                               <?php echo $this->lang->line('Add Notice') ?>
                                            </label>
                                            <div class="col-sm-7">
											<textarea placeholder="Note"  class="form-control margin-bottom" name="note" rows="4"></textarea></div>
                                        </div>
						</div>
                    </div>
