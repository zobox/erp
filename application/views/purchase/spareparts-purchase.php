        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                            ...
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12"><h3
                                                class="title"><?php echo $this->lang->line('Purchase Sparepart') ?> </h3>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="toAddInfo"
                                               class="caption"><?php echo $this->lang->line('Payment Terms') ?></label> <select name="pterms" class="selectpicker form-control"><?php foreach ($terms as $row) {
                                            echo '<option value="' . $row['id'] . '">' . $row['title'] . '</option>';
                                        } ?>
                    ...
                    <input type="hidden" value="purchase/sparepartaction" id="action-url">
                    <input type="hidden" value="sparepart_search" id="billtype">
