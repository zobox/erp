            ...
            <div id="invoice-template" class="card-body">
                <div class="row wrapper white-bg page-heading">
                    ...
                    <div class="col-lg-12">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            {    
                                ?>
                            <a href="<?php echo 'marginal_edit?id=' . $invoice['iid']; ?>" class="btn btn-warning"><i
                           ...
                           elseif($invoice['type']==3)

                            {
                                ...
                                <a href="<?php echo 'sparepart_edit?id=' . $invoice['iid']; ?>" class="btn btn-warning"><i
                                        class="fa fa-pencil"></i> <?php echo $this->lang->line('Edit Order') ?> </a>          
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1"> <?php if($invoice['type']==2){ echo "MRG_";}else if($invoice['type']==3){ echo "SP_"; } echo prefix(2) . $invoice['tid'] . '</p>
