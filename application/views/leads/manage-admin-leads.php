...
<div class="content-body">
    <div class="card">
        <div class="card-header pb-0">
            <h4>Manage Tele Caller Admin Leads </h4>
            ...
            <div class="card-body">
                ...
                <table id="cgrtable" class="table table-striped table-bordered zero-configuration table-responsive" cellspacing="0" style="border:none;">
                    ...
                    <tr>
                        ...
                        <th style="width: 130px;">Assign RSM</th>
                        <th>Status</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                    ...
                    <tr>
						...
						<td>
							<select style="height:32px;min-width:100px; <?php if($lead_data->agency_id != NULL){echo 'display:none;';}?>" name="assign_to[<?php echo $lead_data->id; ?>]" id="assignLead<?php echo $lead_data->id; ?>" class='form-control b_input assignLead' <?php if($lead_data->agency_id != NULL){echo "disabled=''";}?>>
								 <option value="" selected="selected" disabled>Select</option>
								  <?php foreach($rsm as $key1=>$emp_data){ ?>
                        ...
                        <td><a href="#remarks<?php echo $lead_data->id; ?>" data-toggle="modal" data-remote="false" data-type="reminder" class="btn btn-success btn-sm"><span class="fa fa-eye"></span> View Remarks</a></td>
                    </tr>
            ...
            <div class="modal-body">
                <form class="payment" method="post" action="#">
                    ...
                    <div style="display: flex;">
                                <h6><?php echo $lead_data->employee->name; ?></h6> 
                                <h6 style="margin-left: 67%;"><?php echo date('d-m-y',strtotime($lead_data->date_modified)); ?></h6>
                    </div>
                            <div class="input-group">
                            <textarea name="message" class="form-control" rows="6" cols="60" placeholder="Others" disabled><?php echo $lead_data->remarks; ?></textarea>                           
                            </div>
                        </div>
