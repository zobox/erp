                        ...
                        <div class="">
									...
									<div class="form-group row mt-1">
										...
										<div class="col-sm-3 col-lg-2">
											<select name="website_id" id="website_id" class="form-control b_input required">
												...
												<option <?php if($franchise->website_id==1){ ?> selected <?php } ?> value="1">Zobox</option>
												<option <?php if($franchise->website_id==2){ ?> selected <?php } ?> value="2">Zoloot</option>
											</select>																		
										</div>
									</div>
									...
									<div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-3 col-lg-2">
                                            <select name="personal_company" id="personal_company" class="form-control b_input required">
												<option value="">Select</option>
												<option <?php if($franchise->personal_company==2){ ?> selected <?php } ?> value="2">Company</option>
												<option <?php if($franchise->personal_company==1){ ?> selected <?php } ?> value="1">Individual</option>
											</select>																		
                                        </div>
                                    </div>
									...
									<div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-3 col-lg-2">
											<select name="module" id="module" class="form-control b_input required">
												<option value="">Select</option>
												<option <?php if($franchise->module==1){ ?> selected <?php } ?> value="1">Enterprise</option>
												<option <?php if($franchise->module==2){ ?> selected <?php } ?> value="2">Professional</option>
												<option <?php if($franchise->module==3){ ?> selected <?php } ?> value="3">Standard</option>
											</select>																		
                                        </div>
                                    </div>
             			...
             			<div class="">
                              <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="<?php echo $this->lang->line('RTGS/ IFSC Code') ?>"
												   ...
												   id="ifsc_code" value="<?php echo $franchise->iec_code; ?>">
                                        </div>
                                    </div>
									<div class="form-group row">
                                        <label class="col-sm-2 col-form-label"
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="file" id="pan_card_up" name="pan_card_up" accept="image/*"/ <?php if($franchise->pan_card_up == ''){?>required<?php } ?> >
											<input type="hidden" name="pan_card_up_old" id="pan_card_up_old" value="<?php echo $franchise->pan_card_up; ?>">
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                  	<div class="col-md-12">
                                    <input type="file" id="cancelled_cheque_up" name="cancelled_cheque_up" accept="image/*">
							...
							<div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
									...
									<div class="col-md-12">
                                    <input type="file" id="abcd" name="abcd" accept="image/*" />
                                ...
                                <div class="col-md-12">
									...
									<input type="submit" id="submit-data11"
                                           ...
                                           data-loading-text="Adding...">
											...
											<input type="hidden" name="id" id="id" value="<?php echo $franchise->id; ?>">
                                </div>
