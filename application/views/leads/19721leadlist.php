        ...
        <div class="card">
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-1 bg-gradient-x-warning white media-body">
                        <h6 style="font-size:13px;"><?= $this->lang->line('Unable to Convert Franchise') ?></h6>
                        <h6 style="font-size:13px;" class="text-bold-400 mb-0"><i
        ...
        <div class="card">
            <div class="card-content">
			   ...
			   <form name="filter" id="fromfilter" method="post" action="<?php echo base_url(); ?>leads">
                ...
                <table id="cgrtable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="90%">
					...
					<thead>
                        ...
                        <th class="th-data" style=" padding-top: -1.75rem;
						padding-right: 1rem;
						padding-bottom: -1.75rem;
						padding-left: 1rem;">#</th>
                        <th class="th-data">Name</th>                        
                        <th class="th-data">Email</th>
                        <th class="th-data">Mobile</th>
                        <th class="th-data" style="text-align:center;">Source</th>
                        <th class="th-data" style=" max-width: 150px;
						white-space: nowrap;">Date</th>
                        <th class="th-data">State</th>
                        <th class="th-data">City</th>
                        <th class="th-data">Pincode</th>
                        <th class="th-data">Shop Type</th>
                        <th class="th-data">Assign To</th>
