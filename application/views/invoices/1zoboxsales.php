<div class="content-body">
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" method="post" action="<?php echo  base_url(); ?>invoices/action">
                    <div class="row">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                     class="caption"><?php echo $this->lang->line('Current Business Location'); ?></label>
                                    <select name="from_location" id="from_location" class="selectpicker form-control required">
                                        <option value="">Select Location</option>
                                        <?php
                                        for($i=0;$i<count($locations);$i++)
                                        {
                                            ?>
                                            <option value="<?=$locations[$i]['id']?>"><?=$locations[$i]['cname']?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                                                            class="caption"><?php echo $this->lang->line('To Business Location'); ?></label>
                                   <select id="to_location" name="to_location" class="form-control required select-box">
              <option value="" selected="selected" disabled="disabled"> --- Select ---</option>
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst"
                                        ...
                                        <input type="text" class="form-control round" name="cst" id="customer-box"
                                               ...
                                               autocomplete="off"/>
                                        <div id="customer-box-result" class="ctbox"></div>
                                    </div>
                                </div>
                                ...
                                <div id="customer" class="mb-2">
                                   ...
                                   <div class="col-sm-6 mb-2" style="margin-left: -13px;"><label for=""
                                                                 class="caption mb-0"><?php echo $this->lang->line('Serial No'); ?></label>

                                        <div class="input-group" style="width:613px;">
                                        ...
                                        <input type="text" class="form-control" placeholder="Serial No" name="serial"                                                   
                                                   autocomplete="false" id="zobox_sales_serialno">                          
                                        </div>
                                    </div>
                                    <!--<div class="col-sm-6 pt-2" style="margin-left: -13px;"><label for="toAddInfo"
                                               class="caption"><?php echo $this->lang->line('Invoice Note') ?></label>

                                        <div class="input-group pb-2" style="width: 612px;">
                                            <div class="input-group-addon"><span class="icon-calendar4"
                                                                                 aria-hidden="true"></span></div>
                                                                                 <textarea class="form-control round" name="notes" rows="3"></textarea>
                                        </div>
                                    </div>-->
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-sm-6">
                                        <label
                                               class="caption"><?php echo $this->lang->line('Payment Terms') ?></label>
                                               <select name="pterms"
                                    ...
                                    <div class="col-sm-6">
                                        <label
                                               class="caption"><label for=""
                                                                 class="caption"><?php if (isset($employee)){
                                ...
                                <!--<div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="toAddInfo"
                                               class="caption"><?php echo $this->lang->line('Invoice Note') ?></label>
                                        <textarea class="form-control round" name="notes" rows="3"></textarea></div>
                                </div>-->
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr class="item_header bg-gradient-directional-blue white">
                                ...
                                <th width="8%" class="text-center">Actual Price</th>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-0"
                                           ...
                                           autocomplete="off" value="1"><input type="hidden" id="alert-0" value=""
                                                                               name="alert[]"></td>
                                <td><input type="text" class="form-control req prc" name="actual_price[]" id="actual_price-0"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off"></td>                                               
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td colspan="6" class="reverse_align"><strong><?php echo $this->lang->line('Grand Total') ?>
                                        (<span
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td class="reverse_align" colspan="9" style="text-align:center;"><input type="submit"
                    ...
                    <input type="hidden" value="search_product_by_serial_zoboxsales" id="billtype">
