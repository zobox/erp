<div class="content-body">
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" method="post" action="<?php echo  base_url(); ?>invoices/actionb2b">
                    <div class="row">
						...
						<div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    <div class="form-group row">
                                        <div class="col-sm-2">
                                            <button class="btn btn-info w-100" type="button" data-toggle="modal"
                                    data-target="#Pos_addCustomer"> <?php echo $this->lang->line('Add') ?></button>
                                        </div>
                                        <div class="col-sm-10">
                                            <input type="text" name="new" id="pos-customer-box-B2B" placeholder="Enter Customer Name" class="form-control">
                                        </div>
                                    </div>
                                 ...
                                 <div class="col-sm-12"><label for="invociedate"
                                                                 class="caption"><?php echo $this->lang->line('Warehouse'); ?></label>
                                <select id="s_warehouses" name="s_warehouses" class="form-control round" <?php if ($this->aauth->get_user()->roleid != 5) { echo 'disabled'; } else { $wid=1; } ?> required>
                                    <?php
                                     ...
                                     foreach ($warehouse as $row) { 
                                        ...
                                        ?>  
                                         ...
                                         <option value="<?php echo $row['id']; ?>" <?php if($row['id']==$wid){ ?>selected="selected"<?php } ?>><?php echo $row['title']; ?></option>
                                     <?php } ?>
                                    ...
                                    <div class="row mb-3">
                                    <div class="col-sm-12">
                                            <label for="" class="caption col-form-label"><?php echo $this->lang->line('Serial No'); ?></label>
                                            <div class="input-group">
                                                <div class="input-group-addon mb-1"><span class="icon-calendar4"
                                                                                     aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="Serial No" name="serial"
											autocomplete="false" id="serial_nos">                          
                                            </div>
                                        </div>
                                      </div>
                                ...
                                <div id="customer">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                           ...
                                           class="form-control margin-bottom" id="cname" name="cname" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label" for="name">Customer Phone</label>
                                            <div class="input-group">
                                                <input type="phone" placeholder="Phone"
                                           class="form-control margin-bottom" id="cphone" name="cphone" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label" for="name">Customer Email</label>
                                            <div class="input-group">
                                                <input type="email" placeholder="Email"
                                           class="form-control margin-bottom" id="cemail" name="cemail" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label" for="name">Customer Address</label>
                                            <div class="input-group">
                                                <input type="text" placeholder="Address"
                                           class="form-control margin-bottom"  id="caddress" name="caddress" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="col-form-label" for="name">Customer GST</label>
                                            <div class="input-group">
                                                <input type="text" placeholder=""
                                           class="form-control margin-bottom" id="cgst"  name="cgst" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon mb-1"><span class="icon-calendar4"
                                                                                     aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="Serial No" name="serial"                   
                                                       id="serial_nos" autocomplete="false" id="zobox_sales_serialno">                          
                                            </div>
                                        </div>
                                      </div>                                    
                                </div>                               
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
							...
							<!--<tr>
                                <td><input type="text" class="form-control invoice2_searchb2b" name="product_name[]"
                                           placeholder="<?php echo $this->lang->line('Enter Product name') ?>"
                                           id='product_name-0'>
                                            <input type="hidden" value="" id="cnt">
                                </td>
                   ...
                   <?php if ($this->aauth->get_user()->roleid != 5) { ?>
                    ...
                    <input type="hidden" name="s_warehouses" value="<?php echo $wid; ?>" id="s_warehouses1">
                    <?php } ?>
                    <input type="hidden" name="franchise_id" value="<?php echo $franchise_id; ?>" id="franchise_id">
                    <input type="hidden" value="new_i" id="inv_page">
                    <input type="hidden" value="invoices/actionb2b" id="action-url">
                    <!--<input type="hidden" value="search_product_by_serialb2b" id="billtype">-->
                    <input type="hidden" value="invoice2_searchb2b" id="billtype">
