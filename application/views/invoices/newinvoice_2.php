<div class="content-body">
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" method="post" action="<?php echo  base_url(); ?>invoices/action2">
                    ...
                    <input type="hidden" value="invoices/action2" id="action-url">
                    <input type="hidden" value="invoice2_search" id="billtype">
