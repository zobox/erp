            ...
            <div id="invoice-template" class="card-body">
                ...
                <div id="invoice-company-details" class="row mt-2">
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
						...
						<p class="ml-2"> <?php //echo
							...
							if($invoice['type']==2){
								...
								echo $loc['address'] . '<br>' . $loc['city'] . ', ' . $loc['region'] . '<br>' . $loc['country'] . ' -  ' . $loc['postbox'];
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1"> <?php echo $prefix . $invoice['tid'] . '</p>
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    ...
                    <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
                        ...
                        <?php echo '<p><span class="text-muted">' . $this->lang->line('Invoice Date') . '  :</span> ' . dateformat($invoice['invoicedate']) . '</p>   <p><span class="text-muted">' . $this->lang->line('Terms') . ' :</span> ' . $invoice['termtit'] . '</p>'; ?>
                    </div>
                </div>
                <!--/ Invoice Customer Details -->
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs-right"><?php echo amountExchange($total_gst, 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
									<?php } ?>
									<?php if($total_marginal_gst_price>0){ ?>
									<tr>
                                        <td><?php echo $this->lang->line('Tax BIfurcation') ?></td>
                                        <td class="text-xs-right"><?php echo amountExchange($total_marginal_gst_price, 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
									<?php } ?>
                                    <tr>
