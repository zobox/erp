                ...
                <form method="post" id="data_form" class="form-horizontal">
                    <table id="" class="table table-striped table-bordered zero-configuration table-responsive"
                        ...
                        <tr>
							...
							<th><?php echo $this->lang->line('role9') ?></th>
							<th><?php echo $this->lang->line('role10') ?></th>
                            <th><?php echo $this->lang->line('TRC Manager') ?></th>
                            <th><?php echo $this->lang->line('TRC Team Leader') ?></th>
                            <th><?php echo $this->lang->line('TRC Quality Manager') ?></th>
                            <th><?= $this->lang->line('Telle Caller Admin') ?></th>
                            <th><?= $this->lang->line('Telle Callers') ?></th>
							<!--<th><?php echo $this->lang->line('role11') ?></th>-->
                        </tr>
                        </thead>
                        <tbody>
                        <?php $i = 1;
