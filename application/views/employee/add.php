<div class="content-body">
    ...
    <div class="card card-block bg-white">
        ...
        <!--<form method="post" id="data_form" class="card-body" action="<?php echo base_url(); ?>employee/submit_user">-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <select name="roleid" id="roleid" class="form-control margin-bottom">
							...
							<option value="9"><?= $this->lang->line('role9') ?></option>
							<option value="10"><?= $this->lang->line('role10') ?></option>
							<option value="11"><?= $this->lang->line('Branding Team') ?></option>
							<option value="12"><?= $this->lang->line('TRC Manager') ?></option>
							<option value="13"><?= $this->lang->line('TRC Team Leader') ?></option>
							<option value="14"><?= $this->lang->line('TRC Quality Manager') ?></option>
                            <option value="15"><?= $this->lang->line('Telle Caller Admin') ?></option>
                            <option value="16"><?= $this->lang->line('Telle Callers') ?></option>
							<!--<option value="11"><?= $this->lang->line('role11') ?></option>-->
                        </select>
                    </div>
                </div>
...
<script>
	...
	$('#roleid').change(function(){
		...
		if(roleid==2){
				$.ajax({
				url: baseurl+'customers/get_franchise_dropdown',
				type: 'POST',
				data: {roleid:roleid},				
				success: function (data) {
					$("#franchise").html(data);					
