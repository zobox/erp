          ...
          <div class="row mt-3">
            <div class="col-md-12"> <a href="<?php echo base_url('customers/view?id=' . $details['id']) ?>"
                                   ...
                                   class="btn btn-success btn-md mr-1 mb-1 btn-block btn-lighten-1"><i
                                            class="fa fa-file-text"></i> <?php echo $this->lang->line('View Invoices') ?> </a> 
                                   ...
                                   class="btn btn-blue-grey btn-md mr-1 mb-1 btn-block  btn-lighten-1"><i
                                            class="fa fa-money"></i> <?php echo $this->lang->line('View Transactions') ?> </a> 
                                   ...
                                   class="btn btn-flickr btn-md mr-1 mb-1 btn-block btn-lighten-1"><i
                                            class="fa fa-calendar-check-o"></i> <?php echo $this->lang->line('Subscriptions') ?> </a> 
											<a href="<?php echo base_url('customers/notes?id=' . $details['id']) ?>"
                                   class="btn btn-github btn-block btn-md mr-1 mb-1 btn-lighten-1"><i
                                            class="fa fa-book"></i> <?php echo $this->lang->line('Notes') ?> </a> 
        ...
        <div class="col-md-8">
          ...
          <table id="invoices" class="table table-striped table-bordered zero-configuration"
            ...
            <thead>
                    <tr>
                        <th>#</th>
                        <th>Asset <?php echo $this->lang->line('Name') ?></th>
                    ...
                    <tbody>
                      <tr>
                         ...
                         ?>
                        <th>#<?php echo $result[$i]['tid']?></th>
                        <th><?php echo $result[$i]['asset']?></th>
                        <th><?php echo round($result[$i]['qty'])?></th>
                        <th><?php echo round($result[$i]['code'])?></th>
                        <th><?php echo $parent_cat[$i]?></th>
                        <th><?php echo $result[$i]['warehouse_code']?></th>
                      </tr>
                    <?php } ?>
