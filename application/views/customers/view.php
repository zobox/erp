                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="">
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('FranchiseID') ?></strong>
                                </div>
                                <div class="col-md-10">
                                    <?php echo $details['franchise_code'] ?>
                                </div>
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('WarehouseID') ?></strong>
                                </div>
                                <div class="col-md-10">
							...
							<div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong><?php echo $this->lang->line('StoreID') ?></strong>
                                </div>
                                <div class="col-md-10">
