            ...
            <div class="card-body">
				<form method="post" id="data_form" class="form-horizontal">
						<div class="row">
							<div class="col-sm-5">
								<div class="form-group row">
									<label class="col-sm-5 col-form-label" for="income"><?php echo $this->lang->line('Income') ?></label>
									<div class="col-sm-7">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" for="expense"><?php echo $this->lang->line('Expenses') ?></label>
									<div class="col-sm-8">
						...
						<div class="row">
							<div class="col-sm-5">
								<div class="form-group row">
									<label class="col-sm-5 col-form-label" for="sales"><?php echo $this->lang->line('Sales') ?></label>
									<div class="col-sm-7">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" for="netincome"><?php echo $this->lang->line('Net Income') ?></label>
									<div class="col-sm-8">
