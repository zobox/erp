                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <input type="hidden" name="po_type" value="<?=$product[0]['po_type']?>">
                            ...
                            <div class="clientinfo">
                                ...
                                <div type="text" id="customer_phone">Phone: <strong>' . $product[0]['supp_phone'] . '</strong><br>Email: <strong>' . $product[0]['supp_email'] . '</strong></div>
                                        ...
                                        <hr><?php echo $this->lang->line('Warehouse') ?> <select id="s_warehouses"
                                            ...
                                            <?php
                                            echo '<option value="'.$product[0]['franchise_code'].'">' . $product[0]['warehouse_title'].'</option>';
                                            ?>
                                        ...
                                        <div class="col-sm-6"><label for="invociedate"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control required editdate"
                                                       ...
                                                       autocomplete="false"
                                                       value="<?php echo dateformat($invoice['invoicedate']) ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6"><label for="invocieduedate"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control required editdate"
                                                       ...
                                                       value="<?php echo dateformat($invoice['invoiceduedate']) ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="saman-row">
                            <table class="table-responsive tfr my_stripe">
                                ...
                                foreach ($products as $row) {
                                    echo '<tr >
                        <td><input type="text" class="form-control" name="product_name[]" placeholder="Enter Product name or Code"  value="' . $row['asset'] . '">
                        </td>
