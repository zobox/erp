      ...
      <form method="post" id="data_form"> <?php /*?>action="<?php echo base_url()?>products/addproduct"<?php */?>
        ...
        <div class="form-group row">
          <div class="col-sm-6">
            ...
            <input type="text" placeholder="<?php echo $this->lang->line('Asset Name') ?>" class="form-control margin-bottom required" name="product_name" value="<?=$product['asset_name']?>">
          </div>
            ...
            <select class="form-control margin-bottom required" id="brand" name="brand" required>
              ...
              <?php 
                    foreach($brand as $key=>$brand_row){
                        echo "<option value='".$brand_row['id']."'";if($brand_row['id'] == $product['b_id']){echo "selected='selected'";}echo">".$brand_row['brand_name']." (".$brand_row['extra'].") "."</option>";
                    }
                ?>
            </select>
          </div>
        ...
        <div class="form-group row">
          <div class="col-sm-6">
            ...
            <input type="text" placeholder="<?php echo $this->lang->line('Product Code') ?>" class="form-control" name="hsn_code" value="<?php echo $product['product_code'] ?>">
          </div>
          <div class="col-sm-6">
            <label class="col-form-label" for="product_code"><?php echo $this->lang->line('Asset Model') ?></label>
            <input type="text" placeholder="<?php echo $this->lang->line('Asset Model') ?>" class="form-control" name="product_model" value="<?php echo $product['product_model'] ?>" readonly>
          </div>
        </div>
        <hr />
        <div class="form-group row">
         <div class="col">
          ...
          <input type="text" placeholder="<?php echo $this->lang->line('Warehouse Asset Name') ?>" class="form-control required" name="warehouse_product_name" value="<?=$product['warehouse_product_name']?>">
            </div>
            <div class="col">
          <label class="col-form-label" for="product_warehouse"><?php echo $this->lang->line('Warehouse Product Code') ?>*</label>
          <input type="text" placeholder="<?php echo $this->lang->line('Warehouse Product Code') ?>" class="form-control required" name="warehouse_product_code" value="<?php echo $product['warehouse_product_code'] ?>" readonly>
            </div>
        ...
        <div class="form-group row">
          ...
          <label class="col-form-label"><?php echo "BarCode Numeric Digit"; ?></label>
            <input type="text" placeholder="BarCode Numeric Digit 123112345671"
                               ...
                               value="<?php echo $product['barcode'] ?>" readonly
        ...
        <div class="form-group row">
          ...
          <div class="col">
            ...
            <input type="text" placeholder="<?php echo $this->lang->line('Alert Quantity') ?>"  class="form-control margin-bottom" name="product_qty_alert" id="product_qty_alert" onkeypress="return isNumber(event)" value="<?php echo $product['alert'] ?>">
          </div>
         <div class="col">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-4">
            <input type="submit" id="submit-data" class="btn btn-lg btn-blue margin-bottom"
                               value="Edit Asset" data-loading-text="Adding...">
            <input type="hidden" value="asset/edit_asset" id="action-url">
          </div>
        </div>
        ...
        $('#fileupload').fileupload({
            ...
            formData: {'<?=$this->security->get_csrf_token_name()?>': crsf_hash},
                ...
                $.each(data.result.files, function (index, file) {
                    $('#files').html('<tr><td><a data-url="<?php echo base_url() ?>asset/file_handling?op=delete&name=' + file.name + '" class="aj_delete"><i class="btn-danger btn-sm icon-trash-a"></i> ' + file.name + ' </a><img style="max-height:200px;" src="<?php echo base_url() ?>userfiles/product/' + file.name + '"></td></tr>');
                    img = file.name;
                });
