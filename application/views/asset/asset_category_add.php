    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <h5><?php echo $this->lang->line('Add New Asset Category') ?></h5>
                <hr>
				
				<div class="form-group row">

                    <label class="col-sm-2 col-form-label"
                           for="product_catname"><?php echo $this->lang->line('Website') ?></label>

                    <div class="col-sm-2">
						<div class="radio">
						  <label><input type="radio" value="1" name="website_id" id="zobox" checked> ZoBox</label>
						</div>																						
					</div>
					
					<div class="col-sm-4">
						<div class="radio">
						  <label><input type="radio" value="2" name="website_id" id="zoloot"> ZoLoot</label>
						</div>
					</div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" value="asset/add_asset_cat" id="action-url">
                    </div>
                </div>
