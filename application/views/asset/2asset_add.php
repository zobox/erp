      ...
      <form method="post" id="data_form"> <?php /*?>action="<?php echo base_url()?>products/addproduct"<?php */?>
        ...
        <div class="form-group row">
		  ...
		  <div class="col-sm-6">
            ...
            <input type="text" placeholder="<?php echo $this->lang->line('Asset Model') ?>" class="form-control" name="product_model">
          </div>
        </div>
        <hr />
        <div class="form-group row">
		 <div class="col">
          ...
          <input type="text" placeholder="<?php echo $this->lang->line('Warehouse Product Code') ?>" class="form-control required" name="warehouse_product_code">
			</div>
