<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Asset Category') ?> <a
                        href="<?php echo base_url('asset/addasset_category') ?>"
                        class="btn btn-info small-button">
                    <?php echo $this->lang->line('Add new') . ' ' . $this->lang->line('Category') ?>
                </a> <a
                        href="<?php echo base_url('asset/addasset_sub_category') ?>"
                        class="btn btn-info small-button">
            ...
            <div class="card-body pt-0  ">
                ...
                <table id="catgtable" class="table table-striped table-bordered zero-configuration">
                    ...
                    foreach ($cat as $row) {
						...
						switch($website_id){
							case 1: $website_name = 'ZoBox';
							break;
							case 2: $website_name = 'ZoLoot';
							break;
                    ...
                    <td>$i</td>
                    <td>$website_name</td>
                    <td><a href='" . base_url("asset/category_view?id=$cid") . "' >$title</a></td>
                    <td>$total</td>
                    <td>$qty</td>
                    <td>$salessum/$worthsum</td>
                    <td><a href='" . base_url("asset/category_view?id=$cid") . "' class='btn btn-success btn-sm'><i class='fa fa-eye'></i> " . $this->lang->line('View') . "</a>&nbsp; <a class='btn btn-blue  btn-sm' href='" . base_url() . "asset/report_product?id=" . $cid . "' target='_blank'> <span class='fa fa-pie-chart'></span> " . $this->lang->line('Reports') . "</a>&nbsp;  <a href='" . base_url("asset/category_edit?id=$cid") . "' class='btn btn-warning btn-sm'><i class='fa fa-pencil'></i> " . $this->lang->line('Edit') . "</a>&nbsp;<a href='#' data-object-id='" . $cid . "' class='btn btn-danger btn-sm delete-object' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="action-url" value="asset/asset_cat_delete">
