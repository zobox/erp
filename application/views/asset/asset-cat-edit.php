            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
					...
					<div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label" for="product_cat_name">Website</label>

                        <div class="col-sm-2">
							<div class="radio">
							  <label><input type="radio" value="1" name="website_id" id="zobox" <?php if($productcat['website_id']==1 || $productcat['website_id']==0){ ?> checked <?php } ?>> ZoBox</label>
							</div>																						
						</div>
						
						<div class="col-sm-4">
							<div class="radio">
							  <label><input type="radio" value="2" name="website_id" id="zoloot" <?php if($productcat['website_id']==2){ ?> checked <?php } ?>> ZoLoot</label>
							</div>
						</div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" value="asset/editcat" id="action-url">
                        </div>
                    </div>
