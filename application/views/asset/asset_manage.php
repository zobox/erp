<div class="content-body">
    ...
    <div class="card">
         <div class="card-header">
            <h5><?php echo $this->lang->line('Assets') ?> <a
                        href="<?php echo base_url('asset/add') ?>"
                        class="btn btn-info small-button">
                    <?php echo $this->lang->line('Add new') ?>
                </a>  <a
                        href="<?php echo base_url('asset') ?>?group=yes"
                        class="btn btn-info small-button"><i class="ft-grid"></i></a> <a
                        href="<?php echo base_url('asset') ?>"
                        class="btn btn-info small-button"><i class="ft-list"></i></a></h5>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                table = $('#productstable').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('asset/asset_list')?>",
                        "type": "POST",
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="action-url" value="asset/delete_i">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="view-action-url" value="asset/view_over">
