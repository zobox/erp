...
class Categories_model extends CI_Model
{
	...
	public function get_warehouseProductById($wid){
		...
		$this->db->join('geopos_products as d', 'b.pid = d.pid', 'left');
		$this->db->join("geopos_sale_price_calculator as e",'d.pid=e.pid','inner');
	...
	public function save_jobcard_resend_log($serial){
		...
		$jc = array(            
			...
			'date_modified' => $j_c_d->date_modified
		);			
