...
class Jobwork_model extends CI_Model
{
	...
	public function getJobWorkDetail($request_id){ 
		$this->db->select("b.id,a.serial,a.sub_cat,a.sub_sub_cat,a.batch_number,a.assign_engineer,a.change_status,a.final_qc_status,a.final_qc_remarks,a.teamlead_id,a.final_condition,a.type,c.product_condition,e.id as issue_id,f.id as request_id,f.convert_to,g.username as teamlead,h.username as trc_manager");
	...
	public function jobWorkManage(){
		$this->db->select("b.id,a.id as jobcard_id,a.serial,a.assign_engineer,a.change_status,a.final_qc_status,a.final_qc_remarks,c.product_condition,f.convert_to");
		$this->db->from("tbl_jobcard as a");
		$this->db->join("geopos_product_serials as b","a.serial=b.serial",'left');
		$this->db->join("tbl_qc_data as c","a.serial=c.imei1",'left');
		$this->db->join("tbl_jobwork_issue_serial as d","a.serial=d.serial",'left');
