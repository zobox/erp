...
<link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/fonts/flag-icon-css/css<?= LTR ?>/flag-icon.min.css">
...
<link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/css<?= LTR ?>/core/menu/menu-types/vertical-menu.css">
<link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/css<?= LTR ?>/core/menu/menu-types/vertical-overlay-menu.css">
  ...
  <div class="navbar-wrapper">
    <div class="navbar-header">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item">
		<a href="<?php echo base_url() ?>" class="navbar-brand nav-link">
		<img alt="branding logo" src="<?php echo substr_replace(base_url(), '', -7); ?>/userfiles/theme/logo-header.png" data-expand="<?php echo substr_replace(base_url(), '', -7); ?>/userfiles/theme/logo-header.png" data-collapse="<?php echo substr_replace(base_url(), '', -7); ?>/userfiles/theme/logo-header.png" class="brand-logo height-50"></a></li>
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" id="side">
  ...
  <div class="main-menu-content">
	...
	<li class="nav-item <?php if ($this->uri->segment(1) == "dashboard") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>dashboard/"> <i class="icon-file-text"></i><span class="menu-title"> <?php echo $this->lang->line('dashboard'); ?> </span></a> </li>
	<li class="nav-item <?php if ($this->uri->segment(1) == "lead") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>lead/"> <i class="icon-file-text"></i><span class="menu-title"> <?php echo $this->lang->line('lead'); ?> </span></a> </li>
      <li class="nav-item <?php if ($this->uri->segment(1) == "invoices") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>invoices/"> <i class="icon-file-text"></i><span class="menu-title"> <?php echo $this->lang->line('Invoices'); ?> </span></a> </li>
      <?php /*?><li class="nav-item <?php if ($this->uri->segment(1) == "rec_invoices") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>subscriptions/"> <i class="icon-android-calendar"></i><span class="menu-title"> <?php echo $this->lang->line('Subscriptions'); ?> </span></a> </li>
      <li class="nav-item <?php if ($this->uri->segment(1) == "quote") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>quote/"> <i class="icon-file"></i><span class="menu-title"> <?php echo $this->lang->line('Quotes'); ?> </span></a> </li>
      ...
      <li class="nav-item <?php if($this->uri->segment(1) == "payments") echo "active"; ?>"> <a href="<?php echo base_url("payments"); ?>"><i class="icon-cash"></i> <span><?php echo $this->lang->line('Payment History'); ?></span></a> </li><?php */?>
      ...
      <li class="nav-item <?php if ($this->uri->segment(2) == "profile") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>user/profile"> <i class="icon-user1"></i><span class="menu-title"> <?php echo $this->lang->line('Profile') ?> </span></a> </li>
      <li class="nav-item <?php if ($this->uri->segment(1) == "address") {
                echo 'active';
            } ?>"> <a href="<?php echo base_url(); ?>user/address"> <i class="icon-address-book"></i><span class="menu-title"> <?php echo $this->lang->line('Address') ?> </span></a> </li>
      <li class="nav-item "> <a href="<?php echo base_url(); ?>commisson/"><i class="icon-stack"></i> <span><?php echo "Commison Structure";//echo $this->lang->line('Project'); ?></span></a> </li>
    </ul>
  </div>
  <!-- /main menu content-->
  <!-- main menu footer-->
