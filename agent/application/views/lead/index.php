    ...
    <div class="content-body">
      ...
      <div class="card card-block">
        <div class="box-header with-border">
          ...
          <div class="row" style="margin: 5px; padding: 5px; border: 1px dotted black;">
		 
            <div class="col-md-1">New<br /><?php echo $new;?></div>
            <div class="col-md-1">Contacted<br /><?php echo $contacted;?></div>
            <div class="col-md-1">Qualified<br /><?php echo $qualified;?></div>
            <div class="col-md-2">Proposal Sent<br /><?php echo $proposal_sent;?></div>
            <div class="col-md-1">Franchise<br /><?php echo $converted_to_franchhise;?></div>
            <div class="col-md-3">Unable to Convert Franchise<br /><?php echo $not_converted_to_franchhise;?></div>
            <div class="col-md-1">Total<br /><?php echo $total;?></div>
            <div class="col-md-1">Junk<br /><?php echo $junk;?></div>
            <div class="col-md-1">Test<br /><?php echo $test;?></div>
          </div>
