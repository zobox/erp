                    ...
                    <div class="row wrapper white-bg page-heading">
                        ...
                        <div class="col-lg-12">
                            ...
                            if ($invoice['status'] != 'canceled') {
                                /*echo ' <div class="title-action"> <a href="' . $linkp . '"  class="btn btn-large btn-info" title="Partial Payment"
...
<th scope="row">' . $c . '</th>
                    ...
                    <?php /*?><div id="invoice-footer"><p class="lead"><?php echo $this->lang->line('Credit Transactions') ?>:</p>
                        <table class="table table-striped">
                            <thead>
                            <tr>
