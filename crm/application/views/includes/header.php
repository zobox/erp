...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" id="side">
    ...
    <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main mt-2">
			...
			<li class="nav-item <?php if($this->uri->segment(1) == "commission_wallet") echo "active"; ?>">
                <a href="<?php echo base_url("commission_wallet"); ?>"><i class="icon-credit-card2"></i>
                    <span><?php echo $this->lang->line('Comission Wallet'); ?></span></a>
            </li>
			...
			<li class="nav-item <?php if($this->uri->segment(1) == "productinventory") echo "active"; ?>">
                <a href="<?php echo base_url("productinventory"); ?>"><i class="icon-stack"></i>
                    <span><?php echo "Product Inventory"; ?></span></a>
            </li>
