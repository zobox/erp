          ...
          <div id="invoices_wrapper" class="dataTables_wrapper">
            ...
            <table id="invoices" class="cell-border example1 table table-striped table1 delSelTable dataTable" role="grid" aria-describedby="invoices_info">
              ...
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 45px;" aria-label="Qty: activate to sort column ascending">Qty</th>
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 63px;" aria-label="Code: activate to sort column ascending">Code</th>
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 100px;" aria-label="Category: activate to sort column ascending">Category</th>
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 73px;" aria-label="Warehouse: activate to sort column ascending">Warehouse</th>
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 49px;" aria-label=" Price: activate to sort column ascending"> Price</th>
                <th class="sorting" tabindex="0" aria-controls="productstable" rowspan="1" colspan="1" style="width: 50px;" aria-label="Settings: activate to sort column ascending">Settings</th>
              </tr>
            </thead>
              <tbody>
              ...
              <tr role="row" class="odd">
                ...
                <td><a href="<?=base_url();?>productinventory/serial_list?pid=<?=$row->pid?>" data-object-id="41" class="btn btn-success  btn-sm  view-object"><span class="fa fa-eye"></span> View</a>
                  <!--<div class="btn-group">
                    ...
                    <div class="dropdown-menu"> <a class="dropdown-item" href="<?php $baseurl_array[0]; ?>productinventory/barcode?id=<?php echo $row->pid; ?>" target="_blank"> BarCode</a>
                      ...
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="<?php $baseurl_array[0]; ?>productinventory/poslabel?id=<?php echo $row->pid; ?>" target="_blank"> Label - Compact</a></div>
                  </div>
              -->
