...
$(document).ready(function () {
	...
	$("#pos-customer-box-B2B").keyup(function () {
        $.ajax({
            type: "GET",
            url: baseurl + 'search_products/pos_c_search_b2b',
            data: 'keyword=' + $(this).val() + '&' + crsf_token + '=' + crsf_hash,
            beforeSend: function () {
                $("#customer-box").css("background", "#FFF url(" + baseurl + "assets/custom/load-ring.gif) no-repeat 165px");
            },
...
$("#mclient_add1").click(function (e) {
    e.preventDefault();
    var actionurl = baseurl + 'invoices/add_customers';
    searchCS(actionurl);
	//location.reload();
});
