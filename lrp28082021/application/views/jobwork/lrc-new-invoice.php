              ...
              <div class="card-header p-0" style="border-bottom:none;">
                    ...
                    <div id="customerpanel" class="inner-cmp-pnl">
                      ...
                      <div class="col-sm-12">
                        <div id="customer">						
                          ...
                          <select id="to_warehouses1" name="to_warehouses1" class="form-control round" disabled>
                    ...
                    <div class="inner-cmp-pnl">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control round" placeholder="Invoice #" name="invocieno" value="<?php echo $lastinvoice + 1 ?>" readonly="readonly"> </div>
                        </div>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6">
                          ...
                          <div class="input-group">
                            <div class="input-group-addon"><span class="icon-calendar4" aria-hidden="true"></span></div>
                            <input type="text" class="form-control round" placeholder="Billing Date" name="invoicedate" data-toggle="datepicker" autocomplete="false" readonly="readonly"> </div>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-sm-12">					
					...
					<input type="hidden" name="s_warehouses" value="<?php echo $wid->id; ?>" id="s_warehouses">
