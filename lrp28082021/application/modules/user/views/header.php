...
<head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/css/bootstrap.css">
    <!-- font icons-->
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/fonts/icomoon.css">
    <link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/fonts/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/vendors/css/extensions/pace.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/css/app.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/css/colors.css">
     <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/agent-assets/css/custom.css">
    <!-- END ROBUST CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css"
          href="<?php echo assets_url(); ?>agent-assets/css/core/menu/menu-types/vertical-overlay-menu.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url(); ?>agent-assets/css/pages/login-register.css">
    ...
    <script src="<?php echo assets_url(); ?>agent-assets/myjs/jquery.password-validation.js" type="text/javascript"></script>
