                ...
                <div id="invoice-template" class="card-block">
                    ...
                    <div id="invoice-company-details" class="row">
                        ...
                        <div class="col-md-3 col-sm-12 text-xs-center text-md-right">
                            ...
                            <p class="pb-1"> <?php echo $this->config->item('prefix') . ' #' . $invoice[0]->tid . '</p>
                            <p class="pb-1">Reference:' . $invoice['refer'] . '</p>'; ?>
                            <ul class="px-0 list-unstyled">
                                <li><?php echo $this->lang->line('Gross Amount') ?></li>
                                <li class="lead text-bold-800"><?php echo amountExchange($invoice[0]->total, $invoice['multi']) ?></li>
                            </ul>
                        </div>
                    </div>
                    <!--/ Invoice Company Details -->
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="offset-md-5 col-md-3 col-sm-12 text-xs-center text-md-left">
                            <?php echo '<p><span class="text-muted">'.$this->lang->line('Invoice Date').':</span> ' . $invoice[0]->invoicedate . '</p> <p><span class="text-muted">'.$this->lang->line('Due Date').' :</span> ' . $invoice['invoiceduedate'] . '</p>  <p><span class="text-muted">'.$this->lang->line('Terms').' :</span> ' . $invoice['termtit'] . '</p>';
                            ?>
                        </div>
                    </div>
                    <!--/ Invoice Customer Details -->
